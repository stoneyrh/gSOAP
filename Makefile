...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in mkinstalldirs $(srcdir)/gsoap.pc.in \
	$(srcdir)/gsoap++.pc.in $(srcdir)/gsoapck.pc.in \
	$(srcdir)/gsoapck++.pc.in $(srcdir)/gsoapssl.pc.in \
	$(srcdir)/gsoapssl++.pc.in compile config.guess config.sub \
...
ACLOCAL = ${SHELL} /Users/engelen/Projects/gsoap/packages/gsoap-2.8/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /Users/engelen/Projects/gsoap/packages/gsoap-2.8/missing automake-1.14
AWK = awk
...
WSDL2H_EXTRA_LIBS =  ../plugin/httpda.c ../plugin/md5evp.c ../plugin/threads.c -lssl -lcrypto -lz
