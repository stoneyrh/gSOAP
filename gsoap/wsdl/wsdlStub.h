...
#define wsdlStub_H
#include "stdsoap2.h"
#if GSOAP_VERSION != 20842
# error "GSOAP VERSION 20842 MISMATCH IN GENERATED CODE VERSUS LIBRARY CODE: PLEASE REINSTALL PACKAGE"
#endif
...
class SOAP_CMAC __wadl__method_resource_choice {
      ...
      public:
        /// Constructor with initializations
        __wadl__method_resource_choice()
        {
          method = (wadl__method *)0;
          resource = (wadl__resource *)0;
        }
...
class SOAP_CMAC wadl__resource : public wadl__resource_USCOREtype {
      public:
        ...
        char *queryType;	///< default = (char*)"application/x-www-form-urlencoded"
        /// optional attribute 'path' of XSD type 'xsd:string'
        char *path;
      private:
        /// Not serialized
      ...
      public:
        ...
        {
          type = (char *)0;
          queryType = (char*)"application/x-www-form-urlencoded";
          path = (char *)0;
        }
