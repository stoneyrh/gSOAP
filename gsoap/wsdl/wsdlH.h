/* wsdlH.h
   Generated by gSOAP 2.8.23 from ./wsdl.h
...
inline wsdl__ext_fault * soap_new_set_wsdl__ext_fault(struct soap *soap, char *name, char *ref, char *messageLabel, char *wsoap__code, char *wsoap__subcodes, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, soap__fault *soap__fault_, const std::vector<wsoap__module >& wsoap__module_) { wsdl__ext_fault *_p = soap_instantiate_wsdl__ext_fault(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__ext_fault::name = name; _p->wsdl__ext_fault::ref = ref; _p->wsdl__ext_fault::messageLabel = messageLabel; _p->wsdl__ext_fault::wsoap__code = wsoap__code; _p->wsdl__ext_fault::wsoap__subcodes = wsoap__subcodes; _p->wsdl__ext_fault::documentation = documentation; _p->wsdl__ext_fault::wsp__Policy_ = wsp__Policy_; _p->wsdl__ext_fault::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__ext_fault::soap__fault_ = soap__fault_; _p->wsdl__ext_fault::wsoap__module_ = wsoap__module_; } return _p; }
...
inline wsdl__types * soap_new_set_wsdl__types(struct soap *soap, char *documentation, const std::vector<xs__schema * >& xs__schema_, char *targetNamespace1, char *version1, char *defaultAttributes1, enum xs__formChoice attributeFormDefault1, enum xs__formChoice elementFormDefault1, xs__annotation *annotation1, const std::vector<xs__include >& include1, const std::vector<xs__override >& override_1, const std::vector<xs__redefine >& redefine1, const std::vector<xs__import >& import1, const std::vector<xs__attribute >& attribute1, const std::vector<xs__element >& element1, const std::vector<xs__group >& group1, const std::vector<xs__attributeGroup >& attributeGroup1, const std::vector<xs__simpleType >& simpleType1, const std::vector<xs__complexType >& complexType1) { wsdl__types *_p = soap_instantiate_wsdl__types(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__types::documentation = documentation; _p->wsdl__types::xs__schema_ = xs__schema_; _p->xs__schema::targetNamespace = targetNamespace1; _p->xs__schema::version = version1; _p->xs__schema::defaultAttributes = defaultAttributes1; _p->xs__schema::attributeFormDefault = attributeFormDefault1; _p->xs__schema::elementFormDefault = elementFormDefault1; _p->xs__schema::annotation = annotation1; _p->xs__schema::include = include1; _p->xs__schema::override_ = override_1; _p->xs__schema::redefine = redefine1; _p->xs__schema::import = import1; _p->xs__schema::attribute = attribute1; _p->xs__schema::element = element1; _p->xs__schema::group = group1; _p->xs__schema::attributeGroup = attributeGroup1; _p->xs__schema::simpleType = simpleType1; _p->xs__schema::complexType = complexType1; } return _p; }
...
inline wsdl__portType * soap_new_set_wsdl__portType(struct soap *soap, char *name, char *extends, char *styleDefault, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, const std::vector<wsdl__fault >& fault, const std::vector<wsdl__operation >& operation) { wsdl__portType *_p = soap_instantiate_wsdl__portType(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__portType::name = name; _p->wsdl__portType::extends = extends; _p->wsdl__portType::styleDefault = styleDefault; _p->wsdl__portType::documentation = documentation; _p->wsdl__portType::wsp__Policy_ = wsp__Policy_; _p->wsdl__portType::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__portType::fault = fault; _p->wsdl__portType::operation = operation; } return _p; }
...
inline wsp__PolicyAttachment * soap_new_set_wsp__PolicyAttachment(struct soap *soap, wsp__AppliesTo *AppliesTo, const std::vector<wsp__Attachment >& Attachment) { wsp__PolicyAttachment *_p = soap_instantiate_wsp__PolicyAttachment(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsp__PolicyAttachment::AppliesTo = AppliesTo; _p->wsp__PolicyAttachment::Attachment = Attachment; } return _p; }
...
inline sp__Elements * soap_new_set_sp__Elements(struct soap *soap, char *XPathVersion, const std::vector<char * >& XPath) { sp__Elements *_p = soap_instantiate_sp__Elements(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->sp__Elements::XPathVersion = XPathVersion; _p->sp__Elements::XPath = XPath; } return _p; }
...
inline sp__Parts * soap_new_set_sp__Parts(struct soap *soap, char *Body, const std::vector<sp__Header >& Header, char *Attachments) { sp__Parts *_p = soap_instantiate_sp__Parts(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->sp__Parts::Body = Body; _p->sp__Parts::Header = Header; _p->sp__Parts::Attachments = Attachments; } return _p; }
...
inline gwsdl__portType * soap_new_set_gwsdl__portType(struct soap *soap, char *name, char *extends, char *documentation, const std::vector<wsdl__operation * >& operation, const std::vector<sd__serviceData >& sd__serviceData_, sd__staticServiceDataValues *sd__staticServiceDataValues_) { gwsdl__portType *_p = soap_instantiate_gwsdl__portType(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->gwsdl__portType::name = name; _p->gwsdl__portType::extends = extends; _p->gwsdl__portType::documentation = documentation; _p->gwsdl__portType::operation = operation; _p->gwsdl__portType::sd__serviceData_ = sd__serviceData_; _p->gwsdl__portType::sd__staticServiceDataValues_ = sd__staticServiceDataValues_; } return _p; }
...
inline wsdl__operation * soap_new_req_wsdl__operation(struct soap *soap, int __union1, const union wsdl__union_ioput& __ioput1, int __union2, const union wsdl__union_ioput& __ioput2) { wsdl__operation *_p = soap_instantiate_wsdl__operation(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__operation::__union1 = __union1; _p->wsdl__operation::__ioput1 = __ioput1; _p->wsdl__operation::__union2 = __union2; _p->wsdl__operation::__ioput2 = __ioput2; } return _p; }

inline wsdl__operation * soap_new_set_wsdl__operation(struct soap *soap, char *name, char *pattern, char *style, char *wrpc__signature, char *parameterOrder, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, int __union1, const union wsdl__union_ioput& __ioput1, int __union2, const union wsdl__union_ioput& __ioput2, const std::vector<wsdl__fault >& fault, const std::vector<wsdl__fault >& infault, const std::vector<wsdl__fault >& outfault) { wsdl__operation *_p = soap_instantiate_wsdl__operation(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__operation::name = name; _p->wsdl__operation::pattern = pattern; _p->wsdl__operation::style = style; _p->wsdl__operation::wrpc__signature = wrpc__signature; _p->wsdl__operation::parameterOrder = parameterOrder; _p->wsdl__operation::documentation = documentation; _p->wsdl__operation::wsp__Policy_ = wsp__Policy_; _p->wsdl__operation::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__operation::__union1 = __union1; _p->wsdl__operation::__ioput1 = __ioput1; _p->wsdl__operation::__union2 = __union2; _p->wsdl__operation::__ioput2 = __ioput2; _p->wsdl__operation::fault = fault; _p->wsdl__operation::infault = infault; _p->wsdl__operation::outfault = outfault; } return _p; }
...
inline mime__multipartRelated * soap_new_set_mime__multipartRelated(struct soap *soap, const std::vector<mime__part >& part) { mime__multipartRelated *_p = soap_instantiate_mime__multipartRelated(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->mime__multipartRelated::part = part; } return _p; }
...
inline mime__part * soap_new_set_mime__part(struct soap *soap, soap__body *soap__body_, const std::vector<soap__header >& soap__header_, const std::vector<mime__content >& content) { mime__part *_p = soap_instantiate_mime__part(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->mime__part::soap__body_ = soap__body_; _p->mime__part::soap__header_ = soap__header_; _p->mime__part::content = content; } return _p; }
...
inline soap__header * soap_new_set_soap__header(struct soap *soap, char *message, char *part, enum soap__useChoice use, char *encodingStyle, char *namespace_, const std::vector<soap__headerfault >& headerfault) { soap__header *_p = soap_instantiate_soap__header(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->soap__header::message = message; _p->soap__header::part = part; _p->soap__header::use = use; _p->soap__header::encodingStyle = encodingStyle; _p->soap__header::namespace_ = namespace_; _p->soap__header::headerfault = headerfault; } return _p; }
...
inline wsdl__message * soap_new_set_wsdl__message(struct soap *soap, char *name, char *documentation, const std::vector<wsp__Policy >& wsp__Policy_, const std::vector<wsp__PolicyReference >& wsp__PolicyReference_, const std::vector<wsdl__part >& part) { wsdl__message *_p = soap_instantiate_wsdl__message(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__message::name = name; _p->wsdl__message::documentation = documentation; _p->wsdl__message::wsp__Policy_ = wsp__Policy_; _p->wsdl__message::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__message::part = part; } return _p; }
...
inline wsdl__definitions * soap_new_set_wsdl__definitions(struct soap *soap, char *name, char *targetNamespace, char *version, const std::vector<wsdl__import >& import, char *documentation, wsdl__types *types, const std::vector<wsdl__message >& message, const std::vector<wsdl__portType >& portType, const std::vector<wsdl__portType >& interface_, const std::vector<wsdl__binding >& binding, const std::vector<wsdl__service >& service, char *wsp__UsingPolicy, const std::vector<wsp__Policy >& wsp__Policy_, const std::vector<plnk__tPartnerLinkType >& plnk__partnerLinkType, const std::vector<vprop__tProperty >& vprop__property, const std::vector<vprop__tPropertyAlias >& vprop__propertyAlias, const std::vector<gwsdl__portType >& gwsdl__portType_) { wsdl__definitions *_p = soap_instantiate_wsdl__definitions(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->wsdl__definitions::name = name; _p->wsdl__definitions::targetNamespace = targetNamespace; _p->wsdl__definitions::version = version; _p->wsdl__definitions::import = import; _p->wsdl__definitions::documentation = documentation; _p->wsdl__definitions::types = types; _p->wsdl__definitions::message = message; _p->wsdl__definitions::portType = portType; _p->wsdl__definitions::interface_ = interface_; _p->wsdl__definitions::binding = binding; _p->wsdl__definitions::service = service; _p->wsdl__definitions::wsp__UsingPolicy = wsp__UsingPolicy; _p->wsdl__definitions::wsp__Policy_ = wsp__Policy_; _p->wsdl__definitions::plnk__partnerLinkType = plnk__partnerLinkType; _p->wsdl__definitions::vprop__property = vprop__property; _p->wsdl__definitions::vprop__propertyAlias = vprop__propertyAlias; _p->wsdl__definitions::gwsdl__portType_ = gwsdl__portType_; } return _p; }
...
inline xs__override * soap_new_set_xs__override(struct soap *soap, char *schemaLocation, const std::vector<xs__attribute >& attribute, const std::vector<xs__element >& element, const std::vector<xs__group >& group, const std::vector<xs__attributeGroup >& attributeGroup, const std::vector<xs__simpleType >& simpleType, const std::vector<xs__complexType >& complexType) { xs__override *_p = soap_instantiate_xs__override(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__override::schemaLocation = schemaLocation; _p->xs__override::attribute = attribute; _p->xs__override::element = element; _p->xs__override::group = group; _p->xs__override::attributeGroup = attributeGroup; _p->xs__override::simpleType = simpleType; _p->xs__override::complexType = complexType; } return _p; }
...
inline xs__contents * soap_new_req_xs__contents(struct soap *soap, int __union, const union xs__union_content& __content) { xs__contents *_p = soap_instantiate_xs__contents(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__contents::__union = __union; _p->xs__contents::__content = __content; } return _p; }

inline xs__contents * soap_new_set_xs__contents(struct soap *soap, int __union, const union xs__union_content& __content) { xs__contents *_p = soap_instantiate_xs__contents(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__contents::__union = __union; _p->xs__contents::__content = __content; } return _p; }
...
inline xs__any * soap_new_set_xs__any(struct soap *soap, char *namespace_, enum xs__processContents processContents, char *minOccurs, char *maxOccurs, const std::vector<xs__element >& element) { xs__any *_p = soap_instantiate_xs__any(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__any::namespace_ = namespace_; _p->xs__any::processContents = processContents; _p->xs__any::minOccurs = minOccurs; _p->xs__any::maxOccurs = maxOccurs; _p->xs__any::element = element; } return _p; }
...
inline xs__all * soap_new_set_xs__all(struct soap *soap, const std::vector<xs__element >& element) { xs__all *_p = soap_instantiate_xs__all(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__all::element = element; } return _p; }
...
inline xs__union * soap_new_set_xs__union(struct soap *soap, char *memberTypes, const std::vector<xs__simpleType >& simpleType) { xs__union *_p = soap_instantiate_xs__union(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__union::memberTypes = memberTypes; _p->xs__union::simpleType = simpleType; } return _p; }
...
inline xs__list * soap_new_set_xs__list(struct soap *soap, char *itemType, xs__restriction *restriction, const std::vector<xs__simpleType >& simpleType) { xs__list *_p = soap_instantiate_xs__list(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__list::itemType = itemType; _p->xs__list::restriction = restriction; _p->xs__list::simpleType = simpleType; } return _p; }
...
inline xs__seqchoice * soap_new_set_xs__seqchoice(struct soap *soap, char *minOccurs, char *maxOccurs, xs__annotation *annotation, const std::vector<xs__contents >& __contents) { xs__seqchoice *_p = soap_instantiate_xs__seqchoice(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__seqchoice::minOccurs = minOccurs; _p->xs__seqchoice::maxOccurs = maxOccurs; _p->xs__seqchoice::annotation = annotation; _p->xs__seqchoice::__contents = __contents; } return _p; }
...
inline xs__extension * soap_new_set_xs__extension(struct soap *soap, char *base, xs__group *group, xs__all *all, xs__seqchoice *choice, xs__seqchoice *sequence, const std::vector<xs__attribute >& attribute, const std::vector<xs__attributeGroup >& attributeGroup, xs__anyAttribute *anyAttribute, xs__annotation *annotation, const std::vector<xs__assert >& assert) { xs__extension *_p = soap_instantiate_xs__extension(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__extension::base = base; _p->xs__extension::group = group; _p->xs__extension::all = all; _p->xs__extension::choice = choice; _p->xs__extension::sequence = sequence; _p->xs__extension::attribute = attribute; _p->xs__extension::attributeGroup = attributeGroup; _p->xs__extension::anyAttribute = anyAttribute; _p->xs__extension::annotation = annotation; _p->xs__extension::assert = assert; } return _p; }
...
inline xs__schema * soap_new_set_xs__schema(struct soap *soap, char *targetNamespace, char *version, char *defaultAttributes, enum xs__formChoice attributeFormDefault, enum xs__formChoice elementFormDefault, xs__annotation *annotation, const std::vector<xs__include >& include, const std::vector<xs__override >& override_, const std::vector<xs__redefine >& redefine, const std::vector<xs__import >& import, const std::vector<xs__attribute >& attribute, const std::vector<xs__element >& element, const std::vector<xs__group >& group, const std::vector<xs__attributeGroup >& attributeGroup, const std::vector<xs__simpleType >& simpleType, const std::vector<xs__complexType >& complexType) { xs__schema *_p = soap_instantiate_xs__schema(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->xs__schema::targetNamespace = targetNamespace; _p->xs__schema::version = version; _p->xs__schema::defaultAttributes = defaultAttributes; _p->xs__schema::attributeFormDefault = attributeFormDefault; _p->xs__schema::elementFormDefault = elementFormDefault; _p->xs__schema::annotation = annotation; _p->xs__schema::include = include; _p->xs__schema::override_ = override_; _p->xs__schema::redefine = redefine; _p->xs__schema::import = import; _p->xs__schema::attribute = attribute; _p->xs__schema::element = element; _p->xs__schema::group = group; _p->xs__schema::attributeGroup = attributeGroup; _p->xs__schema::simpleType = simpleType; _p->xs__schema::complexType = complexType; } return _p; }
