/* wsdlH.h
   Generated by gSOAP 2.8.31 for ./wsdl.h
...
inline int soap_write_wsdl__service(struct soap *soap, wsdl__service const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:service", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__port(struct soap *soap, wsdl__port const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:port", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__binding(struct soap *soap, wsdl__binding const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:binding", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__ext_operation(struct soap *soap, wsdl__ext_operation const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-operation", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__ext_fault(struct soap *soap, wsdl__ext_fault const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-fault", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__ext_ioput(struct soap *soap, wsdl__ext_ioput const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-ioput", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__fault(struct soap *soap, wsdl__fault const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:fault", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__ioput(struct soap *soap, wsdl__ioput const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ioput", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__types(struct soap *soap, wsdl__types const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:types", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__import(struct soap *soap, wsdl__import const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:import", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_vprop__tPropertyAlias(struct soap *soap, vprop__tPropertyAlias const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tPropertyAlias", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_vprop__tProperty(struct soap *soap, vprop__tProperty const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tProperty", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_vprop__tQuery(struct soap *soap, vprop__tQuery const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tQuery", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_plnk__tRole(struct soap *soap, plnk__tRole const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "plnk:tRole", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_plnk__tPartnerLinkType(struct soap *soap, plnk__tPartnerLinkType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "plnk:tPartnerLinkType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__portType(struct soap *soap, wsdl__portType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:portType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__PolicyAttachment(struct soap *soap, wsp__PolicyAttachment const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:PolicyAttachment", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__AppliesTo(struct soap *soap, wsp__AppliesTo const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:AppliesTo", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__Attachment(struct soap *soap, wsp__Attachment const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Attachment", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsrmp5__RMAssertion(struct soap *soap, wsrmp5__RMAssertion const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp5:RMAssertion", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsrmp5__Timeout(struct soap *soap, wsrmp5__Timeout const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp5:Timeout", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsrmp__RMAssertion(struct soap *soap, wsrmp__RMAssertion const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp:RMAssertion", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsrmp__Timeout(struct soap *soap, wsrmp__Timeout const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp:Timeout", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sp__Token(struct soap *soap, sp__Token const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Token", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sp__Elements(struct soap *soap, sp__Elements const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Elements", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sp__Parts(struct soap *soap, sp__Parts const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Parts", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sp__Header(struct soap *soap, sp__Header const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Header", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wst__Claims(struct soap *soap, wst__Claims const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wst:Claims", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__Assertion(struct soap *soap, wsp__Assertion const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Assertion", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__PolicyReference(struct soap *soap, wsp__PolicyReference const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:PolicyReference", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__Content(struct soap *soap, wsp__Content const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Content", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsp__Policy(struct soap *soap, wsp__Policy const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Policy", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsa__EndpointReferenceType(struct soap *soap, wsa__EndpointReferenceType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsa:EndpointReferenceType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_gwsdl__portType(struct soap *soap, gwsdl__portType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "gwsdl:portType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sd__staticServiceDataValues(struct soap *soap, sd__staticServiceDataValues const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sd:staticServiceDataValues", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_sd__serviceData(struct soap *soap, sd__serviceData const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sd:serviceData", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__operation(struct soap *soap, wsdl__operation const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:operation", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_whttp__header(struct soap *soap, whttp__header const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "whttp:header", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_http__operation(struct soap *soap, http__operation const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:operation", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_http__binding(struct soap *soap, http__binding const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:binding", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_http__address(struct soap *soap, http__address const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:address", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_dime__message(struct soap *soap, dime__message const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "dime:message", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_mime__mimeXml(struct soap *soap, mime__mimeXml const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:mimeXml", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_mime__multipartRelated(struct soap *soap, mime__multipartRelated const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:multipartRelated", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_mime__part(struct soap *soap, mime__part const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:part", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_mime__content(struct soap *soap, mime__content const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:content", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsoap__header(struct soap *soap, wsoap__header const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsoap:header", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsoap__module(struct soap *soap, wsoap__module const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsoap:module", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__address(struct soap *soap, soap__address const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:address", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__header(struct soap *soap, soap__header const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:header", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__headerfault(struct soap *soap, soap__headerfault const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:headerfault", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__fault(struct soap *soap, soap__fault const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:fault", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__body(struct soap *soap, soap__body const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:body", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__operation(struct soap *soap, soap__operation const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:operation", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_soap__binding(struct soap *soap, soap__binding const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:binding", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__part(struct soap *soap, wsdl__part const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:part", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__message(struct soap *soap, wsdl__message const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:message", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_wsdl__definitions(struct soap *soap, wsdl__definitions const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:definitions", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__redefine(struct soap *soap, xs__redefine const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:redefine", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__override(struct soap *soap, xs__override const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:override", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__include(struct soap *soap, xs__include const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:include", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__import(struct soap *soap, xs__import const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:import", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__complexContent(struct soap *soap, xs__complexContent const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:complexContent", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__whiteSpace(struct soap *soap, xs__whiteSpace const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:whiteSpace", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__length(struct soap *soap, xs__length const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:length", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__simpleContent(struct soap *soap, xs__simpleContent const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:simpleContent", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__pattern(struct soap *soap, xs__pattern const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:pattern", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__enumeration(struct soap *soap, xs__enumeration const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:enumeration", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__attributeGroup(struct soap *soap, xs__attributeGroup const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:attributeGroup", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__anyAttribute(struct soap *soap, xs__anyAttribute const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:anyAttribute", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__contents(struct soap *soap, xs__contents const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:contents", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__any(struct soap *soap, xs__any const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:any", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__all(struct soap *soap, xs__all const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:all", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__attribute(struct soap *soap, xs__attribute const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:attribute", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__element(struct soap *soap, xs__element const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:element", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__alternative(struct soap *soap, xs__alternative const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:alternative", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__assert(struct soap *soap, xs__assert const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:assert", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__annotation(struct soap *soap, xs__annotation const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:annotation", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__union(struct soap *soap, xs__union const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:union", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__list(struct soap *soap, xs__list const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:list", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__group(struct soap *soap, xs__group const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:group", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__seqchoice(struct soap *soap, xs__seqchoice const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:seqchoice", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__restriction(struct soap *soap, xs__restriction const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:restriction", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__extension(struct soap *soap, xs__extension const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:extension", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__complexType(struct soap *soap, xs__complexType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:complexType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__simpleType(struct soap *soap, xs__simpleType const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:simpleType", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline int soap_write_xs__schema(struct soap *soap, xs__schema const *p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:schema", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
