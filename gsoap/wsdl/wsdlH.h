...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_wadl__ParamStyle(struct soap*, enum wadl__ParamStyle *);
...
inline enum wadl__ParamStyle * soap_new_wadl__ParamStyle(struct soap *soap, int n = -1)
{
	return static_cast<enum wadl__ParamStyle *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum wadl__ParamStyle)));
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_wadl__HTTPMethods(struct soap*, enum wadl__HTTPMethods *);
...
inline enum wadl__HTTPMethods * soap_new_wadl__HTTPMethods(struct soap *soap, int n = -1)
{
	return static_cast<enum wadl__HTTPMethods *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum wadl__HTTPMethods)));
}
...
#define soap_default_wadl__statusCodeList(soap, a) soap_default_xsd__string(soap, a)
