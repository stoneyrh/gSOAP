/* wsdlH.h
   Generated by gSOAP 2.8.30 for ./wsdl.h
...
inline enum sd__mutability * soap_new_sd__mutability(struct soap *soap, int n = -1)
{	return static_cast<enum sd__mutability *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum sd__mutability)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_sd__mutability(soap, p, "sd:mutability", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline enum soap__useChoice * soap_new_soap__useChoice(struct soap *soap, int n = -1)
{	return static_cast<enum soap__useChoice *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum soap__useChoice)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_soap__useChoice(soap, p, "soap:useChoice", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline enum soap__styleChoice * soap_new_soap__styleChoice(struct soap *soap, int n = -1)
{	return static_cast<enum soap__styleChoice *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum soap__styleChoice)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_soap__styleChoice(soap, p, "soap:styleChoice", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline enum xs__processContents * soap_new_xs__processContents(struct soap *soap, int n = -1)
{	return static_cast<enum xs__processContents *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum xs__processContents)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xs__processContents(soap, p, "xs:processContents", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline enum xs__attribute_use * soap_new_xs__attribute_use(struct soap *soap, int n = -1)
{	return static_cast<enum xs__attribute_use *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum xs__attribute_use)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xs__attribute_use(soap, p, "xs:attribute-use", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline enum xs__formChoice * soap_new_xs__formChoice(struct soap *soap, int n = -1)
{	return static_cast<enum xs__formChoice *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum xs__formChoice)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xs__formChoice(soap, p, "xs:formChoice", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__boolean(soap, p, "xsd:boolean", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:service", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:port", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:binding", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-operation", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-fault", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ext-ioput", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:fault", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:ioput", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:types", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:import", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tPropertyAlias", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tProperty", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "vprop:tQuery", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "plnk:tRole", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "plnk:tPartnerLinkType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:portType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:PolicyAttachment", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:AppliesTo", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Attachment", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp5:RMAssertion", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp5:Timeout", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp:RMAssertion", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsrmp:Timeout", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Token", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Elements", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Parts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sp:Header", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wst:Claims", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Assertion", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:PolicyReference", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Content", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
inline wsp__Policy * soap_new_set_wsp__Policy(
	...
	wsrmp5__RMAssertion *wsrmp5__RMAssertion_1,
	wsrmp5__RMAssertion *wsrmp5__DeliveryAssurance1,
	char *wsrmp5__AtLeastOnce1,
	char *wsrmp5__AtMostOnce1,
	char *wsrmp5__ExactlyOnce1,
	char *wsrmp5__InOrder1,
...
{	wsp__Policy *_p = soap_new_wsp__Policy(soap);
	...
	{	_p->soap_default(soap);
		...
		_p->wsp__Content::wsrmp5__RMAssertion_ = wsrmp5__RMAssertion_1;
		_p->wsp__Content::wsrmp5__DeliveryAssurance = wsrmp5__DeliveryAssurance1;
		_p->wsp__Content::wsrmp5__AtLeastOnce = wsrmp5__AtLeastOnce1;
		_p->wsp__Content::wsrmp5__AtMostOnce = wsrmp5__AtMostOnce1;
		_p->wsp__Content::wsrmp5__ExactlyOnce = wsrmp5__ExactlyOnce1;
		_p->wsp__Content::wsrmp5__InOrder = wsrmp5__InOrder1;
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsp:Policy", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsa:EndpointReferenceType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "gwsdl:portType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sd:staticServiceDataValues", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "sd:serviceData", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:operation", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "whttp:header", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:operation", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:binding", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "http:address", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "dime:message", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:mimeXml", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:multipartRelated", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:part", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "mime:content", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsoap:header", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsoap:module", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:address", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:header", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:headerfault", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:fault", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:body", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:operation", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "soap:binding", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:part", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:message", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "wsdl:definitions", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:redefine", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:override", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:include", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:import", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:complexContent", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:whiteSpace", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:length", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:simpleContent", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:pattern", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:enumeration", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:attributeGroup", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:anyAttribute", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:contents", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:any", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:all", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:attribute", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:element", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:alternative", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:assert", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:annotation", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:union", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:list", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:group", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:seqchoice", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:restriction", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:extension", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:complexType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:simpleType", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "xs:schema", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xs__namespaceList(soap, p, "xs:namespaceList", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__string(soap, p, "xsd:string", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__QName(soap, p, "xsd:QName", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__NMTOKENS(soap, p, "xsd:NMTOKENS", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__NMTOKEN(soap, p, "xsd:NMTOKEN", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__NCName(soap, p, "xsd:NCName", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_xsd__ID(soap, p, "xsd:ID", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
