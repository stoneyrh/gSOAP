...
[
  [ "gSOAP User Guide", "index.html", [
    ...
    [ "The wsdl2h tool", "index.html#wsdlin", [
      [ "wsdl2h options", "index.html#wsdl2hoptions", [
        [ "wsdl2h -a", "index.html#wsdl2h-a", null ],
        [ "wsdl2h -b", "index.html#wsdl2h-b", null ],
        [ "wsdl2h -c -c++ -c++11", "index.html#wsdl2h-c", null ],
        [ "wsdl2h -D", "index.html#wsdl2h-D", null ],
        [ "wsdl2h -d", "index.html#wsdl2h-d", null ],
        [ "wsdl2h -e", "index.html#wsdl2h-e", null ],
        [ "wsdl2h -F", "index.html#wsdl2h-F", null ],
        [ "wsdl2h -f", "index.html#wsdl2h-f", null ],
        [ "wsdl2h -g", "index.html#wsdl2h-g", null ],
        [ "wsdl2h -h", "index.html#wsdl2h-h", null ],
        [ "wsdl2h -I", "index.html#wsdl2h-I", null ],
        [ "wsdl2h -i", "index.html#wsdl2h-i", null ],
        [ "wsdl2h -j", "index.html#wsdl2h-j", null ],
        [ "wsdl2h -k", "index.html#wsdl2h-k", null ],
        [ "wsdl2h -L", "index.html#wsdl2h-L", null ],
        [ "wsdl2h -l", "index.html#wsdl2h-l", null ],
        [ "wsdl2h -M", "index.html#wsdl2h-M", null ],
        [ "wsdl2h -m", "index.html#wsdl2h-m", null ],
        [ "wsdl2h -N", "index.html#wsdl2h-N", null ],
        [ "wsdl2h -n", "index.html#wsdl2h-n", null ],
        [ "wsdl2h -O", "index.html#wsdl2h-O", null ],
        [ "wsdl2h -o", "index.html#wsdl2h-o", null ],
        [ "wsdl2h -P", "index.html#wsdl2h-P", null ],
        [ "wsdl2h -p", "index.html#wsdl2h-p", null ],
        [ "wsdl2h -Q", "index.html#wsdl2h-Q", null ],
        [ "wsdl2h -q", "index.html#wsdl2h-q", null ],
        [ "wsdl2h -R", "index.html#wsdl2h-R", null ],
        [ "wsdl2h -r", "index.html#wsdl2h-r", null ],
        [ "wsdl2h -S", "index.html#wsdl2h-S", null ],
        [ "wsdl2h -s", "index.html#wsdl2h-s", null ],
        [ "wsdl2h -t", "index.html#wsdl2h-t", null ],
        [ "wsdl2h -U", "index.html#wsdl2h-U", null ],
        [ "wsdl2h -u", "index.html#wsdl2h-u", null ],
        ...
        [ "wsdl2h -_", "index.html#wsdl2h-_", null ]
      ] ],
      [ "Customizing XML data bindings with the typemap.dat file", "index.html#typemap", null ]
    ] ],
    [ "The soapcpp2 tool", "index.html#soapcpp2", [
      [ "soapcpp2 options", "index.html#soapcpp2options", [
        [ "soapcpp2 -0", "index.html#soapcpp2-0", null ],
        [ "soapcpp2 -1", "index.html#soapcpp2-1", null ],
        [ "soapcpp2 -2", "index.html#soapcpp2-2", null ],
        [ "soapcpp2 -A", "index.html#soapcpp2-A", null ],
        [ "soapcpp2 -a", "index.html#soapcpp2-a", null ],
        [ "soapcpp2 -b", "index.html#soapcpp2-b", null ],
        [ "soapcpp2 -C", "index.html#soapcpp2-C", null ],
        [ "soapcpp2 -c -c++ -c++11", "index.html#soapcpp2-c", null ],
        [ "soapcpp2 -d", "index.html#soapcpp2-d", null ],
        [ "soapcpp2 -Ec -Ed -Et", "index.html#soapcpp2-E", null ],
        [ "soapcpp2 -e", "index.html#soapcpp2-e", null ],
        [ "soapcpp2 -f", "index.html#soapcpp2-f", null ],
        [ "soapcpp2 -g", "index.html#soapcpp2-g", null ],
        [ "soapcpp2 -h", "index.html#soapcpp2-h", null ],
        [ "soapcpp2 -I", "index.html#soapcpp2-I", null ],
        [ "soapcpp2 -i", "index.html#soapcpp2-i", null ],
        [ "soapcpp2 -j", "index.html#soapcpp2-j", null ],
        [ "soapcpp2 -L", "index.html#soapcpp2-L", null ],
        [ "soapcpp2 -l", "index.html#soapcpp2-l", null ],
        [ "soapcpp2 -m", "index.html#soapcpp2-m", null ],
        [ "soapcpp2 -n", "index.html#soapcpp2-n", null ],
        [ "soapcpp2 -p", "index.html#soapcpp2-p", null ],
        [ "soapcpp2 -Q", "index.html#soapcpp2-Q", null ],
        [ "soapcpp2 -q", "index.html#soapcpp2-q", null ],
        [ "soapcpp2 -r", "index.html#soapcpp2-r", null ],
        [ "soapcpp2 -S", "index.html#soapcpp2-S", null ],
        [ "soapcpp2 -s", "index.html#soapcpp2-s", null ],
        [ "soapcpp2 -T", "index.html#soapcpp2-T", null ],
        [ "soapcpp2 -t", "index.html#soapcpp2-t", null ],
        [ "soapcpp2 -u", "index.html#soapcpp2-u", null ],
        [ "soapcpp2 -V", "index.html#soapcpp2-V", null ],
        [ "soapcpp2 -v", "index.html#soapcpp2-v", null ],
        [ "soapcpp2 -w", "index.html#soapcpp2-w", null ],
        [ "soapcpp2 -x", "index.html#soapcpp2-x", null ],
        [ "soapcpp2 -y", "index.html#soapcpp2-y", null ],
        [ "soapcpp2 -z", "index.html#soapcpp2-z", null ]
      ] ],
    ...
    [ "Serialization and deserialization rules", "index.html#rules", [
      ...
      [ "Struct and class serialization", "index.html#struct", [
        ...
        [ "Polymorphism, derived types, and dynamic binding in C++", "index.html#polymorph", null ],
        [ "Polymorphism, derived types, and dynamic binding in C", "index.html#polymorphC", null ],
    ...
    [ "Advanced features", "index.html#advanced", [
      ...
      [ "Plugins, modules, and extensions", "index.html#plugins", [
        [ "DOM API overview", "index.html#dom", null ],
...
"index.html#servercookie",
"structsoap.html#acefda44460d269105320e1ebe186608f"
];
