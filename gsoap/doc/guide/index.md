...
from operations defined in other namespaces, thus nicely preventing name clashes in this way.
The
...
tools and automatically added by wsdl2h.

These function prototypes are converted by the soapcpp2 tool to stub functions for remote calls:
