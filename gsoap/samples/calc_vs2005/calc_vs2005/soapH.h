/* soapH.h
   Generated by gSOAP 2.8.45 for calc.h
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__pow(soap, p), 0) || soap_put_ns__pow(soap, p, "ns:pow", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__pow(soap, p), 0) || soap_put_ns__pow(soap, p, "ns:pow", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__pow(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__powResponse(soap, p), 0) || soap_put_ns__powResponse(soap, p, "ns:powResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__powResponse(soap, p), 0) || soap_put_ns__powResponse(soap, p, "ns:powResponse", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__powResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__div(soap, p), 0) || soap_put_ns__div(soap, p, "ns:div", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__div(soap, p), 0) || soap_put_ns__div(soap, p, "ns:div", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__div(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__divResponse(soap, p), 0) || soap_put_ns__divResponse(soap, p, "ns:divResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__divResponse(soap, p), 0) || soap_put_ns__divResponse(soap, p, "ns:divResponse", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__divResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
