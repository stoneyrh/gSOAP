/* soapH.h
   Generated by gSOAP 2.8.30 for calc.h
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__pow(soap, p), 0) || soap_put_ns__pow(soap, p, "ns:pow", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__powResponse(soap, p), 0) || soap_put_ns__powResponse(soap, p, "ns:powResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__div(soap, p), 0) || soap_put_ns__div(soap, p, "ns:div", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__divResponse(soap, p), 0) || soap_put_ns__divResponse(soap, p, "ns:divResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__mul(soap, p), 0) || soap_put_ns__mul(soap, p, "ns:mul", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__mulResponse(soap, p), 0) || soap_put_ns__mulResponse(soap, p, "ns:mulResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__sub(soap, p), 0) || soap_put_ns__sub(soap, p, "ns:sub", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__subResponse(soap, p), 0) || soap_put_ns__subResponse(soap, p, "ns:subResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__add(soap, p), 0) || soap_put_ns__add(soap, p, "ns:add", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize_ns__addResponse(soap, p), 0) || soap_put_ns__addResponse(soap, p, "ns:addResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
