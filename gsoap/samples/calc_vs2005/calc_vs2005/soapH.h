/* soapH.h
   Generated by gSOAP 2.8.11 from calc.h
...
#define soap_write_ns__pow(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__pow(soap, data), 0) || soap_put_ns__pow(soap, data, "ns:pow", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__powResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__powResponse(soap, data), 0) || soap_put_ns__powResponse(soap, data, "ns:powResponse", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__div(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__div(soap, data), 0) || soap_put_ns__div(soap, data, "ns:div", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__divResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__divResponse(soap, data), 0) || soap_put_ns__divResponse(soap, data, "ns:divResponse", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__mul(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__mul(soap, data), 0) || soap_put_ns__mul(soap, data, "ns:mul", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__mulResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__mulResponse(soap, data), 0) || soap_put_ns__mulResponse(soap, data, "ns:mulResponse", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__sub(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__sub(soap, data), 0) || soap_put_ns__sub(soap, data, "ns:sub", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__subResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__subResponse(soap, data), 0) || soap_put_ns__subResponse(soap, data, "ns:subResponse", NULL) || soap_end_send(soap) )
#endif
