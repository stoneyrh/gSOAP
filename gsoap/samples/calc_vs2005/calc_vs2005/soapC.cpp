...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.23 2015-08-16 19:31:16 GMT")
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__pow);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__powResponse);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__div);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__divResponse);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__mul);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__mulResponse);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__sub);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__subResponse);
