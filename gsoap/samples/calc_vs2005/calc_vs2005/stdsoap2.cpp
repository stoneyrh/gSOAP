...
#define GSOAP_LIB_VERSION 20863
...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.8.63 2018-02-17 00:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.8.63 2018-02-17 00:00:00 GMT")
#endif
...
soap_get_http_body(struct soap *soap, size_t *len)
{
  ...
  *s = '\0';
  ...
  if (s)
    (void)soap_memcpy((void*)s, l, (const void*)soap->labbuf, l);
#else
  soap_size_block(soap, NULL, i + 1);
