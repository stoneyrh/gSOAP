...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__pow(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__powResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__div(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__divResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__mul(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__mulResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__sub(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__subResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
