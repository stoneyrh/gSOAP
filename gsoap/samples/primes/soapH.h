...
#ifndef SOAP_TYPE_primes_DEFINED
#define SOAP_TYPE_primes_DEFINED
...
inline primes * soap_new_primes(struct soap *soap, int n = -1)
{
	return soap_instantiate_primes(soap, n, NULL, NULL, NULL);
}

inline primes * soap_new_req_primes(
	struct soap *soap)
{
	primes *_p = soap_new_primes(soap);
	if (_p)
...
inline primes * soap_new_set_primes(
	struct soap *soap,
	const simple_vector<int> & prime)
{
	primes *_p = soap_new_primes(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->primes::prime = prime;
	}
	return _p;
}

inline int soap_write_primes(struct soap *soap, primes const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "primes", p->soap_type() == SOAP_TYPE_primes ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_primes(struct soap *soap, const char *URL, primes const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "primes", p->soap_type() == SOAP_TYPE_primes ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_primes(struct soap *soap, const char *URL, primes const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "primes", p->soap_type() == SOAP_TYPE_primes ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
inline int soap_read_primes(struct soap *soap, primes *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get_primes(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_primes(struct soap *soap, const char *URL, primes *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_primes(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_primes(struct soap *soap, primes *p)
{
	if (soap_read_primes(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_simple_vectorTemplateOfint_DEFINED
#define SOAP_TYPE_simple_vectorTemplateOfint_DEFINED
...
inline simple_vector<int>  * soap_new_simple_vectorTemplateOfint(struct soap *soap, int n = -1)
{
	return soap_instantiate_simple_vectorTemplateOfint(soap, n, NULL, NULL, NULL);
}
#endif
