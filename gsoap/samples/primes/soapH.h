...
inline primes * soap_new_req_primes(struct soap *soap)
...
inline primes * soap_new_set_primes(struct soap *soap,
...
#define soap_read_primes(soap, data) ( ((data) ? ((data)->soap_default(soap), 0) : 0) || soap_begin_recv(soap) || !soap_get_primes(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
