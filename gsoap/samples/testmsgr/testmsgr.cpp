...
static std::string get_reg(const char **pattern, unsigned long l);
static std::string get_seq(const char **pattern, unsigned long l);
static std::string get_rep(const char **pattern, unsigned long l);
static std::string get_sym(const char **pattern, unsigned long l);
         ...
         )
      {
        ...
        while (f && *++a)
        {
          switch (*a)
          {
            ...
            case 'h':
              fprintf(stderr,
                  "Usage: testmsgr [-aact] [-b] [-c] [-dnum] [-f] [-h] [-i] [-j] [-lmax] [-mmax] [-nlen] [-pperc] [-qperc] [-rseed] [-tsec] [-u] [-v] [-A] [-C] [-H] [-M] [-Oopt] [-Pper] [-Rrep] [-Ssel] [infile|-] [URL|port]\n\n"
