/* ./address.h
   Generated by wsdl2h 2.8.20 from ./address.xsd and ./addresstypemap.dat
   2014-12-01 01:24:08 GMT
...
/// </BLOCKQUOTE></PRE>
/// @note The enum values are prefixed with "a__ISO_country__" to avoid name clashes, please use wsdl2h option -e to omit this prefix
enum a__ISO_country
{
...
@section a Top-level root elements of schema "urn:address-book-example"
  ...
  - <address-book> @ref _a__address_book
    @code
