/* calcrest.h
   Generated by wsdl2h 2.8.37 from calcrest.wsdl and typemap.dat
   2016-11-11 18:13:09 GMT
...
///
/// struct ns2__pair operations:
/// - ns2__pair* soap_new_ns2__pair(struct soap*, int num) allocate and default initialize one or more values (array)
...
/// @brief Top-level root element "urn:calc":add of XSD type "urn:calc":pair.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":sub of XSD type "urn:calc":pair.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":mul of XSD type "urn:calc":pair.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":div of XSD type "urn:calc":pair.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":pow of XSD type "urn:calc":pair.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":addResponse of XSD type xs:double.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":subResponse of XSD type xs:double.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":mulResponse of XSD type xs:double.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":divResponse of XSD type xs:double.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "urn:calc":powResponse of XSD type xs:double.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.
