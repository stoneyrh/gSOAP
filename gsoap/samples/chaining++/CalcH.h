...
#define soap_write_byte(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || Calc::soap_put_byte(soap, data, "byte", NULL) || soap_end_send(soap), (soap)->error )
#endif
...
#define soap_write_int(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || Calc::soap_put_int(soap, data, "int", NULL) || soap_end_send(soap), (soap)->error )
#endif
...
#define soap_write_double(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || Calc::soap_put_double(soap, data, "double", NULL) || soap_end_send(soap), (soap)->error )
#endif
