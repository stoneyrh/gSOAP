...
SOAP_SOURCE_STAMP("@(#) CalcC.cpp ver 2.8.22 2015-04-12 20:01:06 GMT")
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_byte);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_int);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_double);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Fault);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Reason);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Detail);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Code);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Header);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__pow);
...
SOAP_FMAC1 struct ns__pow * SOAP_FMAC2 soap_instantiate_ns__pow(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__pow);
		if (size)
			*size = sizeof(struct ns__pow);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__pow, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__powResponse);
...
SOAP_FMAC1 struct ns__powResponse * SOAP_FMAC2 soap_instantiate_ns__powResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__powResponse);
		if (size)
			*size = sizeof(struct ns__powResponse);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__powResponse, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__div);
...
SOAP_FMAC1 struct ns__div * SOAP_FMAC2 soap_instantiate_ns__div(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__div);
		if (size)
			*size = sizeof(struct ns__div);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__div, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__divResponse);
...
SOAP_FMAC1 struct ns__divResponse * SOAP_FMAC2 soap_instantiate_ns__divResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__divResponse);
		if (size)
			*size = sizeof(struct ns__divResponse);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__divResponse, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__mul);
...
SOAP_FMAC1 struct ns__mul * SOAP_FMAC2 soap_instantiate_ns__mul(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__mul);
		if (size)
			*size = sizeof(struct ns__mul);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__mul, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__mulResponse);
...
SOAP_FMAC1 struct ns__mulResponse * SOAP_FMAC2 soap_instantiate_ns__mulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__mulResponse);
		if (size)
			*size = sizeof(struct ns__mulResponse);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__mulResponse, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__sub);
...
SOAP_FMAC1 struct ns__sub * SOAP_FMAC2 soap_instantiate_ns__sub(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__sub);
		if (size)
			*size = sizeof(struct ns__sub);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__sub, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__subResponse);
...
SOAP_FMAC1 struct ns__subResponse * SOAP_FMAC2 soap_instantiate_ns__subResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = SOAP_NEW(struct ns__subResponse);
		if (size)
			*size = sizeof(struct ns__subResponse);
	}
	else
	{	cp->ptr = SOAP_NEW_ARRAY(struct ns__subResponse, n);
		if (size)
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__add);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__addResponse);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Reason);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Detail);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Code);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerTodouble);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc__QName);
...
{
	int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_string);
