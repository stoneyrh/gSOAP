...
SOAP_SOURCE_STAMP("@(#) CalcC.cpp ver 2.8.24 2015-10-25 15:32:20 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE_Calc_ns__divResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__divResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__divResponse*>(p->ptr));
		break;
	case SOAP_TYPE_Calc_ns__div:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__div*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__div*>(p->ptr));
		break;
	case SOAP_TYPE_Calc_ns__powResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__powResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__powResponse*>(p->ptr));
		break;
	case SOAP_TYPE_Calc_ns__pow:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__pow*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__pow*>(p->ptr));
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_Calc_SOAP_ENV__Header:
		if (p->size < 0)
...
#endif
SOAP_FMAC3 int SOAP_FMAC4 Calc_fbase(int t, int b)
{
	do
	{	switch (t)
		{
...
#pragma warning(disable:4065)
#endif
SOAP_FMAC3 void SOAP_FMAC4 Calc_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
...
SOAP_FMAC3 struct SOAP_ENV__Fault * SOAP_FMAC4 soap_in_SOAP_ENV__Fault(struct soap *soap, const char *tag, struct SOAP_ENV__Fault *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct SOAP_ENV__Fault *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_SOAP_ENV__Fault, sizeof(struct SOAP_ENV__Fault), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct SOAP_ENV__Fault *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_SOAP_ENV__Fault, SOAP_TYPE_Calc_SOAP_ENV__Fault, sizeof(struct SOAP_ENV__Fault), 0, Calc_finsert, NULL);
...
SOAP_FMAC1 struct SOAP_ENV__Fault * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Fault(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	int t = SOAP_TYPE_Calc_SOAP_ENV__Fault;
	size_t k;
	...
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 struct SOAP_ENV__Reason * SOAP_FMAC4 soap_in_SOAP_ENV__Reason(struct soap *soap, const char *tag, struct SOAP_ENV__Reason *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct SOAP_ENV__Reason *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_SOAP_ENV__Reason, sizeof(struct SOAP_ENV__Reason), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct SOAP_ENV__Reason *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_SOAP_ENV__Reason, SOAP_TYPE_Calc_SOAP_ENV__Reason, sizeof(struct SOAP_ENV__Reason), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct SOAP_ENV__Reason * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Reason(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	int t = SOAP_TYPE_Calc_SOAP_ENV__Reason;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
...
SOAP_FMAC3 struct SOAP_ENV__Detail * SOAP_FMAC4 soap_in_SOAP_ENV__Detail(struct soap *soap, const char *tag, struct SOAP_ENV__Detail *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct SOAP_ENV__Detail *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_SOAP_ENV__Detail, sizeof(struct SOAP_ENV__Detail), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct SOAP_ENV__Detail *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_SOAP_ENV__Detail, SOAP_TYPE_Calc_SOAP_ENV__Detail, sizeof(struct SOAP_ENV__Detail), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct SOAP_ENV__Detail * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Detail(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	int t = SOAP_TYPE_Calc_SOAP_ENV__Detail;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
...
SOAP_FMAC3 struct SOAP_ENV__Code * SOAP_FMAC4 soap_in_SOAP_ENV__Code(struct soap *soap, const char *tag, struct SOAP_ENV__Code *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct SOAP_ENV__Code *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_SOAP_ENV__Code, sizeof(struct SOAP_ENV__Code), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct SOAP_ENV__Code *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_SOAP_ENV__Code, SOAP_TYPE_Calc_SOAP_ENV__Code, sizeof(struct SOAP_ENV__Code), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct SOAP_ENV__Code * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Code(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	int t = SOAP_TYPE_Calc_SOAP_ENV__Code;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
...
SOAP_FMAC3 struct SOAP_ENV__Header * SOAP_FMAC4 soap_in_SOAP_ENV__Header(struct soap *soap, const char *tag, struct SOAP_ENV__Header *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct SOAP_ENV__Header *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_SOAP_ENV__Header, sizeof(struct SOAP_ENV__Header), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct SOAP_ENV__Header *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_SOAP_ENV__Header, SOAP_TYPE_Calc_SOAP_ENV__Header, sizeof(struct SOAP_ENV__Header), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct SOAP_ENV__Header * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Header(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	int t = SOAP_TYPE_Calc_SOAP_ENV__Header;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
...
ns__pow::ns__pow()
{
	soap_default_ns__pow(NULL, this);
}
...
SOAP_FMAC3 struct ns__pow * SOAP_FMAC4 soap_in_ns__pow(struct soap *soap, const char *tag, struct ns__pow *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__pow *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__pow, sizeof(struct ns__pow), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__pow *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__pow, SOAP_TYPE_Calc_ns__pow, sizeof(struct ns__pow), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__pow * SOAP_FMAC2 soap_instantiate_ns__pow(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__pow *p = NULL;
	int t = SOAP_TYPE_Calc_ns__pow;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__pow);
		k = sizeof(struct ns__pow);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__pow, n);
		k = n * sizeof(struct ns__pow);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__powResponse::ns__powResponse()
{
	soap_default_ns__powResponse(NULL, this);
}
...
SOAP_FMAC3 struct ns__powResponse * SOAP_FMAC4 soap_in_ns__powResponse(struct soap *soap, const char *tag, struct ns__powResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__powResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__powResponse, sizeof(struct ns__powResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__powResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__powResponse, SOAP_TYPE_Calc_ns__powResponse, sizeof(struct ns__powResponse), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__powResponse * SOAP_FMAC2 soap_instantiate_ns__powResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__powResponse *p = NULL;
	int t = SOAP_TYPE_Calc_ns__powResponse;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__powResponse);
		k = sizeof(struct ns__powResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__powResponse, n);
		k = n * sizeof(struct ns__powResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__div::ns__div()
{
	soap_default_ns__div(NULL, this);
}
...
SOAP_FMAC3 struct ns__div * SOAP_FMAC4 soap_in_ns__div(struct soap *soap, const char *tag, struct ns__div *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__div *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__div, sizeof(struct ns__div), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__div *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__div, SOAP_TYPE_Calc_ns__div, sizeof(struct ns__div), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__div * SOAP_FMAC2 soap_instantiate_ns__div(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__div *p = NULL;
	int t = SOAP_TYPE_Calc_ns__div;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__div);
		k = sizeof(struct ns__div);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__div, n);
		k = n * sizeof(struct ns__div);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__divResponse::ns__divResponse()
{
	soap_default_ns__divResponse(NULL, this);
}
...
SOAP_FMAC3 struct ns__divResponse * SOAP_FMAC4 soap_in_ns__divResponse(struct soap *soap, const char *tag, struct ns__divResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__divResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__divResponse, sizeof(struct ns__divResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__divResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__divResponse, SOAP_TYPE_Calc_ns__divResponse, sizeof(struct ns__divResponse), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__divResponse * SOAP_FMAC2 soap_instantiate_ns__divResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__divResponse *p = NULL;
	int t = SOAP_TYPE_Calc_ns__divResponse;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__divResponse);
		k = sizeof(struct ns__divResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__divResponse, n);
		k = n * sizeof(struct ns__divResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__mul::ns__mul()
{
	soap_default_ns__mul(NULL, this);
}
...
SOAP_FMAC3 struct ns__mul * SOAP_FMAC4 soap_in_ns__mul(struct soap *soap, const char *tag, struct ns__mul *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__mul *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__mul, sizeof(struct ns__mul), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__mul *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__mul, SOAP_TYPE_Calc_ns__mul, sizeof(struct ns__mul), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__mul * SOAP_FMAC2 soap_instantiate_ns__mul(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__mul *p = NULL;
	int t = SOAP_TYPE_Calc_ns__mul;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__mul);
		k = sizeof(struct ns__mul);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__mul, n);
		k = n * sizeof(struct ns__mul);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__mulResponse::ns__mulResponse()
{
	soap_default_ns__mulResponse(NULL, this);
}
...
SOAP_FMAC3 struct ns__mulResponse * SOAP_FMAC4 soap_in_ns__mulResponse(struct soap *soap, const char *tag, struct ns__mulResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__mulResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__mulResponse, sizeof(struct ns__mulResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__mulResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__mulResponse, SOAP_TYPE_Calc_ns__mulResponse, sizeof(struct ns__mulResponse), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__mulResponse * SOAP_FMAC2 soap_instantiate_ns__mulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__mulResponse *p = NULL;
	int t = SOAP_TYPE_Calc_ns__mulResponse;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__mulResponse);
		k = sizeof(struct ns__mulResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__mulResponse, n);
		k = n * sizeof(struct ns__mulResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__sub::ns__sub()
{
	soap_default_ns__sub(NULL, this);
}
...
SOAP_FMAC3 struct ns__sub * SOAP_FMAC4 soap_in_ns__sub(struct soap *soap, const char *tag, struct ns__sub *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__sub *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__sub, sizeof(struct ns__sub), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__sub *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__sub, SOAP_TYPE_Calc_ns__sub, sizeof(struct ns__sub), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__sub * SOAP_FMAC2 soap_instantiate_ns__sub(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__sub *p = NULL;
	int t = SOAP_TYPE_Calc_ns__sub;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__sub);
		k = sizeof(struct ns__sub);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__sub, n);
		k = n * sizeof(struct ns__sub);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
ns__subResponse::ns__subResponse()
{
	soap_default_ns__subResponse(NULL, this);
}
...
SOAP_FMAC3 struct ns__subResponse * SOAP_FMAC4 soap_in_ns__subResponse(struct soap *soap, const char *tag, struct ns__subResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__subResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__subResponse, sizeof(struct ns__subResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__subResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__subResponse, SOAP_TYPE_Calc_ns__subResponse, sizeof(struct ns__subResponse), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__subResponse * SOAP_FMAC2 soap_instantiate_ns__subResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__subResponse *p = NULL;
	int t = SOAP_TYPE_Calc_ns__subResponse;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__subResponse);
		k = sizeof(struct ns__subResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__subResponse, n);
		k = n * sizeof(struct ns__subResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
SOAP_FMAC3 struct ns__add * SOAP_FMAC4 soap_in_ns__add(struct soap *soap, const char *tag, struct ns__add *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__add *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__add, sizeof(struct ns__add), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__add *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__add, SOAP_TYPE_Calc_ns__add, sizeof(struct ns__add), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__add * SOAP_FMAC2 soap_instantiate_ns__add(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__add *p = NULL;
	int t = SOAP_TYPE_Calc_ns__add;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__add);
		k = sizeof(struct ns__add);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__add, n);
		k = n * sizeof(struct ns__add);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
SOAP_FMAC3 struct ns__addResponse * SOAP_FMAC4 soap_in_ns__addResponse(struct soap *soap, const char *tag, struct ns__addResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__addResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calc_ns__addResponse, sizeof(struct ns__addResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__addResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calc_ns__addResponse, SOAP_TYPE_Calc_ns__addResponse, sizeof(struct ns__addResponse), 0, Calc_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__addResponse * SOAP_FMAC2 soap_instantiate_ns__addResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct ns__addResponse *p = NULL;
	int t = SOAP_TYPE_Calc_ns__addResponse;
	size_t k;
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (n < 0)
	{	p = SOAP_NEW(struct ns__addResponse);
		k = sizeof(struct ns__addResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__addResponse, n);
		k = n * sizeof(struct ns__addResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p type=%d n=%d\n", p, t, n));
	soap_link(soap, p, t, n, Calc_fdelete);
	if (size)
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_Calc_SOAP_ENV__Reason, NULL);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct SOAP_ENV__Reason ** SOAP_FMAC4 soap_in_PointerToSOAP_ENV__Reason(struct soap *soap, const char *tag, struct SOAP_ENV__Reason **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct SOAP_ENV__Reason **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_Calc_SOAP_ENV__Reason, sizeof(struct SOAP_ENV__Reason), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_Calc_SOAP_ENV__Detail, NULL);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct SOAP_ENV__Detail ** SOAP_FMAC4 soap_in_PointerToSOAP_ENV__Detail(struct soap *soap, const char *tag, struct SOAP_ENV__Detail **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct SOAP_ENV__Detail **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_Calc_SOAP_ENV__Detail, sizeof(struct SOAP_ENV__Detail), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	char *mark;
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_Calc_SOAP_ENV__Code, &mark);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct SOAP_ENV__Code ** SOAP_FMAC4 soap_in_PointerToSOAP_ENV__Code(struct soap *soap, const char *tag, struct SOAP_ENV__Code **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct SOAP_ENV__Code **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_Calc_SOAP_ENV__Code, sizeof(struct SOAP_ENV__Code), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_Calc_double, NULL);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 double ** SOAP_FMAC4 soap_in_PointerTodouble(struct soap *soap, const char *tag, double **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (double **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_Calc_double, sizeof(double), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__QName(struct soap *soap, char *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_reference(soap, *a, SOAP_TYPE_Calc__QName);
#endif
}
...
{	char **p;
	p = soap_instring(soap, tag, a, type, SOAP_TYPE_Calc__QName, 2, 0, -1, NULL);
	return p;
}
...
{	char **p;
	p = soap_instring(soap, tag, a, type, SOAP_TYPE_Calc_string, 1, 0, -1, NULL);
	return p;
}
