...
SOAP_SOURCE_STAMP("@(#) CalcC.cpp ver 2.8.20 2014-12-01 01:24:34 GMT")
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_byte);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_int);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_double);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Fault);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Reason);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Detail);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Code);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_SOAP_ENV__Header);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__pow);
...
SOAP_FMAC1 struct ns__pow * SOAP_FMAC2 soap_instantiate_ns__pow(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns__pow, n);
		if (size)
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__powResponse);
...
SOAP_FMAC1 struct ns__powResponse * SOAP_FMAC2 soap_instantiate_ns__powResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns__powResponse, n);
		if (size)
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__div);
...
SOAP_FMAC1 struct ns__div * SOAP_FMAC2 soap_instantiate_ns__div(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns__div, n);
		if (size)
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__divResponse);
...
SOAP_FMAC1 struct ns__divResponse * SOAP_FMAC2 soap_instantiate_ns__divResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns__divResponse, n);
		if (size)
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__mul);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__mulResponse);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__sub);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__subResponse);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__add);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_ns__addResponse);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Reason);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Detail);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerToSOAP_ENV__Code);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_PointerTodouble);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc__QName);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_Calc_string);
