/* envH.h
   Generated by gSOAP 2.8.15 from env.h
...
inline struct SOAP_ENV__Header * soap_new_set_SOAP_ENV__Header(struct soap *soap, struct h__authentication *h__credentials) { struct SOAP_ENV__Header *_p = soap_instantiate_SOAP_ENV__Header(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_SOAP_ENV__Header(soap, _p); _p->h__credentials = h__credentials; } return _p; }
...
#define soap_write_h__authentication(soap, data) ( soap_serialize_h__authentication(soap, data), soap_begin_send(soap) || soap_put_h__authentication(soap, data, "h:authentication", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_read_h__authentication(soap, data) ( soap_begin_recv(soap) || !soap_get_h__authentication(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif
...
inline struct h__authentication * soap_new_req_h__authentication(struct soap *soap) { struct h__authentication *_p = soap_instantiate_h__authentication(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_h__authentication(soap, _p); } return _p; }

inline struct h__authentication * soap_new_set_h__authentication(struct soap *soap, char *userid, char *passwd) { struct h__authentication *_p = soap_instantiate_h__authentication(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_h__authentication(soap, _p); _p->userid = userid; _p->passwd = passwd; } return _p; }

inline void soap_delete_h__authentication(struct soap *soap, struct h__authentication *p) { soap_delete(soap, p); }
...
#define soap_write_PointerToh__authentication(soap, data) ( soap_serialize_PointerToh__authentication(soap, data), soap_begin_send(soap) || soap_put_PointerToh__authentication(soap, data, "h:authentication", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_read_PointerToh__authentication(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerToh__authentication(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif
