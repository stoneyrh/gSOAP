...
public:
	int soap_type() const { return 10; } /* = unique id SOAP_TYPE_Calc_ns__addResponse */
};
#endif
...
public:
	int soap_type() const { return 11; } /* = unique id SOAP_TYPE_Calc_ns__add */
};
#endif
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 13; } /* = unique id SOAP_TYPE_Calc_ns__subResponse */
};
#endif
...
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 14; } /* = unique id SOAP_TYPE_Calc_ns__sub */
};
#endif
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 16; } /* = unique id SOAP_TYPE_Calc_ns__mulResponse */
};
#endif
...
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 17; } /* = unique id SOAP_TYPE_Calc_ns__mul */
};
#endif
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 19; } /* = unique id SOAP_TYPE_Calc_ns__divResponse */
};
#endif
...
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 20; } /* = unique id SOAP_TYPE_Calc_ns__div */
};
#endif
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 22; } /* = unique id SOAP_TYPE_Calc_ns__powResponse */
};
#endif
...
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 23; } /* = unique id SOAP_TYPE_Calc_ns__pow */
};
#endif
...
{
public:
	int soap_type() const { return 24; } /* = unique id SOAP_TYPE_Calc_SOAP_ENV__Header */
...
public:
	int soap_type() const { return 25; } /* = unique id SOAP_TYPE_Calc_SOAP_ENV__Code */
};
#endif
...
public:
	int soap_type() const { return 27; } /* = unique id SOAP_TYPE_Calc_SOAP_ENV__Detail */
};
#endif
...
public:
	int soap_type() const { return 30; } /* = unique id SOAP_TYPE_Calc_SOAP_ENV__Reason */
};
#endif
...
public:
	int soap_type() const { return 31; } /* = unique id SOAP_TYPE_Calc_SOAP_ENV__Fault */
};
#endif
