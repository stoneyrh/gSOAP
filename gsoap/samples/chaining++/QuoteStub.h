...
struct ns__getQuoteResponse;	/* quote.h:9 */
struct ns__getQuote;	/* quote.h:9 */

/* quote.h:9 */
#ifndef SOAP_TYPE_Quote_ns__getQuoteResponse
#define SOAP_TYPE_Quote_ns__getQuoteResponse (10)
/* ns:getQuoteResponse complex type: */
...
public:
	...
	friend ns__getQuoteResponse *soap_instantiate_ns__getQuoteResponse(struct soap*, int, const char*, const char*, size_t*);
};
#endif
...
public:
	...
	friend ns__getQuote *soap_instantiate_ns__getQuote(struct soap*, int, const char*, const char*, size_t*);
};
#endif
