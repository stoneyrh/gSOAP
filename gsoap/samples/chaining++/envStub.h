...
public:
	int soap_type() const { return 7; } /* = unique id SOAP_TYPE_h__authentication */
};
#endif
...
public:
	int soap_type() const { return 8; } /* = unique id SOAP_TYPE_SOAP_ENV__Header */
};
#endif
...
public:
	int soap_type() const { return 10; } /* = unique id SOAP_TYPE_SOAP_ENV__Code */
};
#endif
...
public:
	int soap_type() const { return 12; } /* = unique id SOAP_TYPE_SOAP_ENV__Detail */
};
#endif
...
public:
	int soap_type() const { return 15; } /* = unique id SOAP_TYPE_SOAP_ENV__Reason */
};
#endif
...
public:
	int soap_type() const { return 16; } /* = unique id SOAP_TYPE_SOAP_ENV__Fault */
};
#endif
