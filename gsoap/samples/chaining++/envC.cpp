...
SOAP_SOURCE_STAMP("@(#) envC.cpp ver 2.8.20 2014-12-01 01:24:34 GMT")
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_h__authentication);
...
SOAP_FMAC1 struct h__authentication * SOAP_FMAC2 soap_instantiate_h__authentication(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct h__authentication, n);
		if (size)
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerToh__authentication);
