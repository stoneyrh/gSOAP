...
/* mashup.h
   Generated by wsdl2h 2.8.30 from gmt.wsdl calc.wsdl mashup.wsdl and typemap.dat
   2016-04-03 00:14:04 GMT
...
///
/// struct _ns1__gmt operations:
/// - soap_default__ns1__gmt(soap*, _ns1__gmt*) reset members to default
/// - int soap_read__ns1__gmt(soap*, _ns1__gmt*) deserialize from a source
/// - int soap_write__ns1__gmt(soap*, _ns1__gmt*) serialize to a sink
/// - _ns1__gmt* soap_dup__ns1__gmt(soap*, _ns1__gmt* dst, _ns1__gmt *src) returns deep copy of _ns1__gmt src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
///
/// struct _ns1__gmtResponse operations:
/// - soap_default__ns1__gmtResponse(soap*, _ns1__gmtResponse*) reset members to default
/// - int soap_read__ns1__gmtResponse(soap*, _ns1__gmtResponse*) deserialize from a source
/// - int soap_write__ns1__gmtResponse(soap*, _ns1__gmtResponse*) serialize to a sink
/// - _ns1__gmtResponse* soap_dup__ns1__gmtResponse(soap*, _ns1__gmtResponse* dst, _ns1__gmtResponse *src) returns deep copy of _ns1__gmtResponse src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
///
/// struct _ns3__commingtotown operations:
/// - soap_default__ns3__commingtotown(soap*, _ns3__commingtotown*) reset members to default
/// - int soap_read__ns3__commingtotown(soap*, _ns3__commingtotown*) deserialize from a source
/// - int soap_write__ns3__commingtotown(soap*, _ns3__commingtotown*) serialize to a sink
/// - _ns3__commingtotown* soap_dup__ns3__commingtotown(soap*, _ns3__commingtotown* dst, _ns3__commingtotown *src) returns deep copy of _ns3__commingtotown src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
Simple calculator service described at http://www.genivia.com/dev.html
