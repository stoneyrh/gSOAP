...
/* mashup.h
   Generated by wsdl2h 2.8.45 from gmt.wsdl calc.wsdl mashup.wsdl and typemap.dat
   2017-04-05 23:22:40 GMT
...
/// - _ns1__gmt* soap_new__ns1__gmt(struct soap*, int num) allocate and default initialize one or more values (array)
...
/// - _ns1__gmtResponse* soap_new__ns1__gmtResponse(struct soap*, int num) allocate and default initialize one or more values (array)
...
/// - _ns3__commingtotown* soap_new__ns3__commingtotown(struct soap*, int num) allocate and default initialize one or more values (array)
