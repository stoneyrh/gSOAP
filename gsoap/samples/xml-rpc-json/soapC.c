/* soapC.c
   Generated by gSOAP 2.8.19 from xml-rpc.h
...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.19 2014-11-08 19:19:30 GMT")
...
{
	register int id = soap_embed(soap, (void*)a, (struct soap_array*)(void*)&a->__ptr, 1, tag, SOAP_TYPE__base64);
