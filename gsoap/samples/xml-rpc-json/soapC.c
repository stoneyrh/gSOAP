...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.20 2014-12-01 01:24:54 GMT")
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_methodCall);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_fault);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_methodResponse);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_param);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_params);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE__array);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_data);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_member);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_value);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE__struct);
...
#ifndef WITH_NOIDREF
	if (a->__ptr)
		soap_array_reference(soap, a, (struct soap_array*)(void*)&a->__ptr, 1, SOAP_TYPE__base64);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__base64(struct soap *soap, const char *tag, int id, const struct _base64 *a, const char *type)
{
	id = soap_element_id(soap, tag, id, a, (struct soap_array*)(void*)&a->__ptr, 1, type, SOAP_TYPE__base64);
	if (id < 0)
		return soap->error;
...
{
	register int id = soap_embed(soap, (void*)a, (struct soap_array*)(void*)&a->__ptr, 1, SOAP_TYPE__base64);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTomethodResponse);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTofault);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerToparams);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerToparam);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_wstring);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTovalue);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTomember);
