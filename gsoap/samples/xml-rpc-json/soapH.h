...
#define soap_write_value(soap, data) ( soap_serialize_value(soap, data), soap_begin_send(soap) || soap_put_value(soap, data, "value", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_PointerTovalue(soap, data) ( soap_serialize_PointerTovalue(soap, data), soap_begin_send(soap) || soap_put_PointerTovalue(soap, data, "value", NULL) || soap_end_send(soap), soap->error )
#endif
