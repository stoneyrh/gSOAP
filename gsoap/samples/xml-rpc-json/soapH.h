...
/* _int is a typedef synonym for int */
...
#define soap__int2s soap_int2s


#define soap_out__int soap_out_int


#define soap_s2_int soap_s2int
...
#define soap_read_time(soap, data) ( ((data) ? (soap_default_time(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_time(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
