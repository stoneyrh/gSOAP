...
class wsdl__fault;	/* wsdl.h:154 */
union wsdl__union_ioput;	/* wsdl.h:193 */
class wsdl__operation;	/* gwsdl.h:41 */
class wsdl__portType;	/* bpel.h:47 */
class wsdl__ext_ioput;	/* wsdl.h:224 */
class wsdl__ext_fault;	/* wsdl.h:246 */
class wsdl__ext_operation;	/* wsdl.h:267 */
class wsdl__binding;	/* wsdl.h:295 */
class wsdl__port;	/* wsdl.h:324 */
class wsdl__service;	/* wsdl.h:347 */
