/* wsdlH.h
   Generated by gSOAP 2.8.12 from wsdl.h
...
#define SOAP_TYPE_sd__mutability (263)
#endif
...
#define soap_write_sd__mutability(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_sd__mutability(soap, data, "sd:mutability", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_soap__useChoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_soap__useChoice(soap, data, "soap:useChoice", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_soap__styleChoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_soap__styleChoice(soap, data, "soap:styleChoice", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__processContents(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xs__processContents(soap, data, "xs:processContents", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__attribute_use(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xs__attribute_use(soap, data, "xs:attribute-use", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__formChoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xs__formChoice(soap, data, "xs:formChoice", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsdl__service (408)
#endif
...
#define soap_write_wsdl__service(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:service", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsdl__port (399)
#endif
...
#define soap_write_wsdl__port(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:port", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsdl__binding (390)
#endif
...
#define soap_write_wsdl__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:binding", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsdl__ext_operation (380)
#endif
...
#define soap_write_wsdl__ext_operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:ext-operation", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsdl__ext_operation(soap, data) ( soap_begin_recv(soap) || !soap_get_wsdl__ext_operation(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline wsdl__ext_operation * soap_new_req_wsdl__ext_operation(struct soap *soap) { wsdl__ext_operation *_p = soap_instantiate_wsdl__ext_operation(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__ext_operation * soap_new_set_wsdl__ext_operation(struct soap *soap, char *name, char *ref, char *wsoap__mep, char *wsoap__action, char *whttp__method, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, soap__operation *soap__operation_, http__operation *http__operation_, wsdl__ext_ioput *input, wsdl__ext_ioput *output, std::vector<wsdl__ext_fault >& fault, std::vector<wsdl__ext_fault >& infault, std::vector<wsdl__ext_fault >& outfault) { wsdl__ext_operation *_p = soap_instantiate_wsdl__ext_operation(soap, -1, NULL, NULL, NULL); _p->wsdl__ext_operation::name = name; _p->wsdl__ext_operation::ref = ref; _p->wsdl__ext_operation::wsoap__mep = wsoap__mep; _p->wsdl__ext_operation::wsoap__action = wsoap__action; _p->wsdl__ext_operation::whttp__method = whttp__method; _p->wsdl__ext_operation::documentation = documentation; _p->wsdl__ext_operation::wsp__Policy_ = wsp__Policy_; _p->wsdl__ext_operation::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__ext_operation::soap__operation_ = soap__operation_; _p->wsdl__ext_operation::http__operation_ = http__operation_; _p->wsdl__ext_operation::input = input; _p->wsdl__ext_operation::output = output; _p->wsdl__ext_operation::fault = fault; _p->wsdl__ext_operation::infault = infault; _p->wsdl__ext_operation::outfault = outfault; return _p; }
...
#define SOAP_TYPE_wsdl__ext_fault (371)
#endif
...
#define soap_write_wsdl__ext_fault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:ext-fault", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__ext_fault * soap_new_req_wsdl__ext_fault(struct soap *soap) { wsdl__ext_fault *_p = soap_instantiate_wsdl__ext_fault(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__ext_fault * soap_new_set_wsdl__ext_fault(struct soap *soap, char *name, char *ref, char *messageLabel, char *wsoap__code, char *wsoap__subcodes, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, soap__fault *soap__fault_, std::vector<wsoap__module >& wsoap__module_) { wsdl__ext_fault *_p = soap_instantiate_wsdl__ext_fault(soap, -1, NULL, NULL, NULL); _p->wsdl__ext_fault::name = name; _p->wsdl__ext_fault::ref = ref; _p->wsdl__ext_fault::messageLabel = messageLabel; _p->wsdl__ext_fault::wsoap__code = wsoap__code; _p->wsdl__ext_fault::wsoap__subcodes = wsoap__subcodes; _p->wsdl__ext_fault::documentation = documentation; _p->wsdl__ext_fault::wsp__Policy_ = wsp__Policy_; _p->wsdl__ext_fault::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__ext_fault::soap__fault_ = soap__fault_; _p->wsdl__ext_fault::wsoap__module_ = wsoap__module_; return _p; }
...
#define SOAP_TYPE_wsdl__ext_ioput (362)
#endif
...
#define soap_write_wsdl__ext_ioput(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:ext-ioput", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsdl__ext_ioput(soap, data) ( soap_begin_recv(soap) || !soap_get_wsdl__ext_ioput(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
#define SOAP_TYPE_wsdl__portType (356)
#endif
...
#define soap_write_wsdl__portType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:portType", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__portType * soap_new_req_wsdl__portType(struct soap *soap) { wsdl__portType *_p = soap_instantiate_wsdl__portType(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__portType * soap_new_set_wsdl__portType(struct soap *soap, char *name, char *extends, char *styleDefault, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_, std::vector<wsdl__fault >& fault, std::vector<wsdl__operation >& operation) { wsdl__portType *_p = soap_instantiate_wsdl__portType(soap, -1, NULL, NULL, NULL); _p->wsdl__portType::name = name; _p->wsdl__portType::extends = extends; _p->wsdl__portType::styleDefault = styleDefault; _p->wsdl__portType::documentation = documentation; _p->wsdl__portType::wsp__Policy_ = wsp__Policy_; _p->wsdl__portType::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__portType::fault = fault; _p->wsdl__portType::operation = operation; return _p; }
...
#define SOAP_TYPE_wsdl__fault (345)
#endif
...
#define soap_write_wsdl__fault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:fault", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__fault * soap_new_req_wsdl__fault(struct soap *soap) { wsdl__fault *_p = soap_instantiate_wsdl__fault(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__fault * soap_new_set_wsdl__fault(struct soap *soap, char *name, char *message, char *ref, char *messageLabel, char *element, char *wsa__Action, char *wsam__Action, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_) { wsdl__fault *_p = soap_instantiate_wsdl__fault(soap, -1, NULL, NULL, NULL); _p->wsdl__fault::name = name; _p->wsdl__fault::message = message; _p->wsdl__fault::ref = ref; _p->wsdl__fault::messageLabel = messageLabel; _p->wsdl__fault::element = element; _p->wsdl__fault::wsa__Action = wsa__Action; _p->wsdl__fault::wsam__Action = wsam__Action; _p->wsdl__fault::documentation = documentation; _p->wsdl__fault::wsp__Policy_ = wsp__Policy_; _p->wsdl__fault::wsp__PolicyReference_ = wsp__PolicyReference_; return _p; }
...
#define SOAP_TYPE_wsdl__ioput (338)
#endif
...
#define soap_write_wsdl__ioput(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:ioput", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsdl__ioput(soap, data) ( soap_begin_recv(soap) || !soap_get_wsdl__ioput(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline wsdl__ioput * soap_new_req_wsdl__ioput(struct soap *soap) { wsdl__ioput *_p = soap_instantiate_wsdl__ioput(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__ioput * soap_new_set_wsdl__ioput(struct soap *soap, char *name, char *message, char *messageLabel, char *element, char *wsa__Action, char *wsam__Action, char *documentation, wsp__Policy *wsp__Policy_, wsp__PolicyReference *wsp__PolicyReference_) { wsdl__ioput *_p = soap_instantiate_wsdl__ioput(soap, -1, NULL, NULL, NULL); _p->wsdl__ioput::name = name; _p->wsdl__ioput::message = message; _p->wsdl__ioput::messageLabel = messageLabel; _p->wsdl__ioput::element = element; _p->wsdl__ioput::wsa__Action = wsa__Action; _p->wsdl__ioput::wsam__Action = wsam__Action; _p->wsdl__ioput::documentation = documentation; _p->wsdl__ioput::wsp__Policy_ = wsp__Policy_; _p->wsdl__ioput::wsp__PolicyReference_ = wsp__PolicyReference_; return _p; }
...
#define SOAP_TYPE_wsdl__types (322)
#endif
...
#define soap_write_wsdl__types(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:types", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__types * soap_new_req_wsdl__types(struct soap *soap) { wsdl__types *_p = soap_instantiate_wsdl__types(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__types * soap_new_set_wsdl__types(struct soap *soap, char *documentation, std::vector<xs__schema * >& xs__schema_, char *targetNamespace1, char *version1, enum xs__formChoice attributeFormDefault1, enum xs__formChoice elementFormDefault1, xs__annotation *annotation1, std::vector<xs__include >& include1, std::vector<xs__redefine >& redefine1, std::vector<xs__import >& import1, std::vector<xs__attribute >& attribute1, std::vector<xs__element >& element1, std::vector<xs__group >& group1, std::vector<xs__attributeGroup >& attributeGroup1, std::vector<xs__simpleType >& simpleType1, std::vector<xs__complexType >& complexType1) { wsdl__types *_p = soap_instantiate_wsdl__types(soap, -1, NULL, NULL, NULL); _p->wsdl__types::documentation = documentation; _p->wsdl__types::xs__schema_ = xs__schema_; _p->xs__schema::targetNamespace = targetNamespace1; _p->xs__schema::version = version1; _p->xs__schema::attributeFormDefault = attributeFormDefault1; _p->xs__schema::elementFormDefault = elementFormDefault1; _p->xs__schema::annotation = annotation1; _p->xs__schema::include = include1; _p->xs__schema::redefine = redefine1; _p->xs__schema::import = import1; _p->xs__schema::attribute = attribute1; _p->xs__schema::element = element1; _p->xs__schema::group = group1; _p->xs__schema::attributeGroup = attributeGroup1; _p->xs__schema::simpleType = simpleType1; _p->xs__schema::complexType = complexType1; return _p; }
...
#define SOAP_TYPE_wsdl__import (314)
#endif
...
#define soap_write_wsdl__import(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:import", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__import * soap_new_req_wsdl__import(struct soap *soap) { wsdl__import *_p = soap_instantiate_wsdl__import(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__import * soap_new_set_wsdl__import(struct soap *soap, char *namespace_, char *location) { wsdl__import *_p = soap_instantiate_wsdl__import(soap, -1, NULL, NULL, NULL); _p->wsdl__import::namespace_ = namespace_; _p->wsdl__import::location = location; return _p; }
...
#define SOAP_TYPE_wsp__PolicyAttachment (311)
#endif
...
#define soap_write_wsp__PolicyAttachment(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:PolicyAttachment", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsp__AppliesTo (310)
#endif
...
#define soap_write_wsp__AppliesTo(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:AppliesTo", NULL) || soap_end_send(soap) )
#endif
...
inline wsp__AppliesTo * soap_new_req_wsp__AppliesTo(struct soap *soap) { wsp__AppliesTo *_p = soap_instantiate_wsp__AppliesTo(soap, -1, NULL, NULL, NULL); return _p; }

inline wsp__AppliesTo * soap_new_set_wsp__AppliesTo(struct soap *soap, char *__any) { wsp__AppliesTo *_p = soap_instantiate_wsp__AppliesTo(soap, -1, NULL, NULL, NULL); _p->wsp__AppliesTo::__any = __any; return _p; }
...
#define SOAP_TYPE_wsp__Attachment (309)
#endif
...
#define soap_write_wsp__Attachment(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:Attachment", NULL) || soap_end_send(soap) )
#endif
...
inline wsp__Attachment * soap_new_req_wsp__Attachment(struct soap *soap) { wsp__Attachment *_p = soap_instantiate_wsp__Attachment(soap, -1, NULL, NULL, NULL); return _p; }

inline wsp__Attachment * soap_new_set_wsp__Attachment(struct soap *soap, wsp__Policy *Policy, wsp__PolicyReference *PolicyReference) { wsp__Attachment *_p = soap_instantiate_wsp__Attachment(soap, -1, NULL, NULL, NULL); _p->wsp__Attachment::Policy = Policy; _p->wsp__Attachment::PolicyReference = PolicyReference; return _p; }
...
#define SOAP_TYPE_wsrmp__RMAssertion (295)
#endif
...
#define soap_write_wsrmp__RMAssertion(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsrmp:RMAssertion", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsrmp__Timeout (294)
#endif
...
#define soap_write_wsrmp__Timeout(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsrmp:Timeout", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsrmp__Timeout(soap, data) ( soap_begin_recv(soap) || !soap_get_wsrmp__Timeout(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline wsrmp__Timeout * soap_new_req_wsrmp__Timeout(struct soap *soap) { wsrmp__Timeout *_p = soap_instantiate_wsrmp__Timeout(soap, -1, NULL, NULL, NULL); return _p; }

inline wsrmp__Timeout * soap_new_set_wsrmp__Timeout(struct soap *soap, char *Milliseconds) { wsrmp__Timeout *_p = soap_instantiate_wsrmp__Timeout(soap, -1, NULL, NULL, NULL); _p->wsrmp__Timeout::Milliseconds = Milliseconds; return _p; }
...
#define SOAP_TYPE_sp__Token (291)
#endif
...
#define soap_write_sp__Token(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sp:Token", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_sp__Elements (289)
#endif
...
#define soap_write_sp__Elements(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sp:Elements", NULL) || soap_end_send(soap) )
#endif
...
inline sp__Elements * soap_new_req_sp__Elements(struct soap *soap) { sp__Elements *_p = soap_instantiate_sp__Elements(soap, -1, NULL, NULL, NULL); return _p; }

inline sp__Elements * soap_new_set_sp__Elements(struct soap *soap, char *XPathVersion, std::vector<char * >& XPath) { sp__Elements *_p = soap_instantiate_sp__Elements(soap, -1, NULL, NULL, NULL); _p->sp__Elements::XPathVersion = XPathVersion; _p->sp__Elements::XPath = XPath; return _p; }
...
#define SOAP_TYPE_sp__Parts (287)
#endif
...
#define soap_write_sp__Parts(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sp:Parts", NULL) || soap_end_send(soap) )
#endif
...
inline sp__Parts * soap_new_req_sp__Parts(struct soap *soap) { sp__Parts *_p = soap_instantiate_sp__Parts(soap, -1, NULL, NULL, NULL); return _p; }

inline sp__Parts * soap_new_set_sp__Parts(struct soap *soap, char *Body, std::vector<sp__Header >& Header, char *Attachments) { sp__Parts *_p = soap_instantiate_sp__Parts(soap, -1, NULL, NULL, NULL); _p->sp__Parts::Body = Body; _p->sp__Parts::Header = Header; _p->sp__Parts::Attachments = Attachments; return _p; }
...
#define SOAP_TYPE_sp__Header (286)
#endif
...
#define soap_write_sp__Header(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sp:Header", NULL) || soap_end_send(soap) )
#endif
...
inline sp__Header * soap_new_req_sp__Header(struct soap *soap) { sp__Header *_p = soap_instantiate_sp__Header(soap, -1, NULL, NULL, NULL); return _p; }

inline sp__Header * soap_new_set_sp__Header(struct soap *soap, char *Name, char *Namespace) { sp__Header *_p = soap_instantiate_sp__Header(soap, -1, NULL, NULL, NULL); _p->sp__Header::Name = Name; _p->sp__Header::Namespace = Namespace; return _p; }
...
#define SOAP_TYPE_wst__Claims (285)
#endif
...
#define soap_write_wst__Claims(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wst:Claims", NULL) || soap_end_send(soap) )
#endif
...
inline wst__Claims * soap_new_req_wst__Claims(struct soap *soap) { wst__Claims *_p = soap_instantiate_wst__Claims(soap, -1, NULL, NULL, NULL); return _p; }

inline wst__Claims * soap_new_set_wst__Claims(struct soap *soap, char *Dialect, char *__item) { wst__Claims *_p = soap_instantiate_wst__Claims(soap, -1, NULL, NULL, NULL); _p->wst__Claims::Dialect = Dialect; _p->wst__Claims::__item = __item; return _p; }
...
#define SOAP_TYPE_wsp__Assertion (283)
#endif
...
#define soap_write_wsp__Assertion(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:Assertion", NULL) || soap_end_send(soap) )
#endif
...
inline wsp__Assertion * soap_new_req_wsp__Assertion(struct soap *soap) { wsp__Assertion *_p = soap_instantiate_wsp__Assertion(soap, -1, NULL, NULL, NULL); return _p; }

inline wsp__Assertion * soap_new_set_wsp__Assertion(struct soap *soap, bool Optional, bool Ignorable, wsp__Content *Policy) { wsp__Assertion *_p = soap_instantiate_wsp__Assertion(soap, -1, NULL, NULL, NULL); _p->wsp__Assertion::Optional = Optional; _p->wsp__Assertion::Ignorable = Ignorable; _p->wsp__Assertion::Policy = Policy; return _p; }
...
#define SOAP_TYPE_wsp__PolicyReference (277)
#endif
...
#define soap_write_wsp__PolicyReference(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:PolicyReference", NULL) || soap_end_send(soap) )
#endif
...
inline wsp__PolicyReference * soap_new_req_wsp__PolicyReference(struct soap *soap) { wsp__PolicyReference *_p = soap_instantiate_wsp__PolicyReference(soap, -1, NULL, NULL, NULL); return _p; }

inline wsp__PolicyReference * soap_new_set_wsp__PolicyReference(struct soap *soap, char *URI, char *Digest, char *DigestAlgorithm) { wsp__PolicyReference *_p = soap_instantiate_wsp__PolicyReference(soap, -1, NULL, NULL, NULL); _p->wsp__PolicyReference::URI = URI; _p->wsp__PolicyReference::Digest = Digest; _p->wsp__PolicyReference::DigestAlgorithm = DigestAlgorithm; return _p; }
...
#define SOAP_TYPE_wsp__Content (274)
#endif
...
#define soap_write_wsp__Content(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:Content", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsp__Policy (273)
#endif
...
#define soap_write_wsp__Policy(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsp:Policy", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_wsa__EndpointReferenceType (272)
#endif
...
#define soap_write_wsa__EndpointReferenceType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsa:EndpointReferenceType", NULL) || soap_end_send(soap) )
#endif
...
inline wsa__EndpointReferenceType * soap_new_req_wsa__EndpointReferenceType(struct soap *soap) { wsa__EndpointReferenceType *_p = soap_instantiate_wsa__EndpointReferenceType(soap, -1, NULL, NULL, NULL); return _p; }

inline wsa__EndpointReferenceType * soap_new_set_wsa__EndpointReferenceType(struct soap *soap, char *Address, char *__any) { wsa__EndpointReferenceType *_p = soap_instantiate_wsa__EndpointReferenceType(soap, -1, NULL, NULL, NULL); _p->wsa__EndpointReferenceType::Address = Address; _p->wsa__EndpointReferenceType::__any = __any; return _p; }
...
#define SOAP_TYPE_gwsdl__portType (267)
#endif
...
#define soap_write_gwsdl__portType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "gwsdl:portType", NULL) || soap_end_send(soap) )
#endif
...
inline gwsdl__portType * soap_new_req_gwsdl__portType(struct soap *soap) { gwsdl__portType *_p = soap_instantiate_gwsdl__portType(soap, -1, NULL, NULL, NULL); return _p; }

inline gwsdl__portType * soap_new_set_gwsdl__portType(struct soap *soap, char *name, char *extends, char *documentation, std::vector<wsdl__operation * >& operation, std::vector<sd__serviceData >& sd__serviceData_, sd__staticServiceDataValues *sd__staticServiceDataValues_) { gwsdl__portType *_p = soap_instantiate_gwsdl__portType(soap, -1, NULL, NULL, NULL); _p->gwsdl__portType::name = name; _p->gwsdl__portType::extends = extends; _p->gwsdl__portType::documentation = documentation; _p->gwsdl__portType::operation = operation; _p->gwsdl__portType::sd__serviceData_ = sd__serviceData_; _p->gwsdl__portType::sd__staticServiceDataValues_ = sd__staticServiceDataValues_; return _p; }
...
#define SOAP_TYPE_sd__staticServiceDataValues (265)
#endif
...
#define soap_write_sd__staticServiceDataValues(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sd:staticServiceDataValues", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_sd__serviceData (264)
#endif
...
#define soap_write_sd__serviceData(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "sd:serviceData", NULL) || soap_end_send(soap) )
#endif
...
inline sd__serviceData * soap_new_req_sd__serviceData(struct soap *soap) { sd__serviceData *_p = soap_instantiate_sd__serviceData(soap, -1, NULL, NULL, NULL); return _p; }

inline sd__serviceData * soap_new_set_sd__serviceData(struct soap *soap, char *name, char *type, bool nillable, char *minOccurs, char *maxOccurs, enum sd__mutability mutability, bool modifiable) { sd__serviceData *_p = soap_instantiate_sd__serviceData(soap, -1, NULL, NULL, NULL); _p->sd__serviceData::name = name; _p->sd__serviceData::type = type; _p->sd__serviceData::nillable = nillable; _p->sd__serviceData::minOccurs = minOccurs; _p->sd__serviceData::maxOccurs = maxOccurs; _p->sd__serviceData::mutability = mutability; _p->sd__serviceData::modifiable = modifiable; return _p; }
...
#define SOAP_TYPE_wsdl__operation (262)
#endif
...
#define soap_write_wsdl__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:operation", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_whttp__header (261)
#endif
...
#define soap_write_whttp__header(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "whttp:header", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_whttp__header(soap, data) ( soap_begin_recv(soap) || !soap_get_whttp__header(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline whttp__header * soap_new_req_whttp__header(struct soap *soap) { whttp__header *_p = soap_instantiate_whttp__header(soap, -1, NULL, NULL, NULL); return _p; }

inline whttp__header * soap_new_set_whttp__header(struct soap *soap, char *name, char *type, bool required) { whttp__header *_p = soap_instantiate_whttp__header(soap, -1, NULL, NULL, NULL); _p->whttp__header::name = name; _p->whttp__header::type = type; _p->whttp__header::required = required; return _p; }
...
#define SOAP_TYPE_http__operation (260)
#endif
...
#define soap_write_http__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "http:operation", NULL) || soap_end_send(soap) )
#endif
...
inline http__operation * soap_new_req_http__operation(struct soap *soap) { http__operation *_p = soap_instantiate_http__operation(soap, -1, NULL, NULL, NULL); return _p; }

inline http__operation * soap_new_set_http__operation(struct soap *soap, char *location) { http__operation *_p = soap_instantiate_http__operation(soap, -1, NULL, NULL, NULL); _p->http__operation::location = location; return _p; }
...
#define SOAP_TYPE_http__binding (259)
#endif
...
#define soap_write_http__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "http:binding", NULL) || soap_end_send(soap) )
#endif
...
inline http__binding * soap_new_req_http__binding(struct soap *soap) { http__binding *_p = soap_instantiate_http__binding(soap, -1, NULL, NULL, NULL); return _p; }

inline http__binding * soap_new_set_http__binding(struct soap *soap, char *verb) { http__binding *_p = soap_instantiate_http__binding(soap, -1, NULL, NULL, NULL); _p->http__binding::verb = verb; return _p; }
...
#define SOAP_TYPE_http__address (258)
#endif
...
#define soap_write_http__address(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "http:address", NULL) || soap_end_send(soap) )
#endif
...
inline http__address * soap_new_req_http__address(struct soap *soap) { http__address *_p = soap_instantiate_http__address(soap, -1, NULL, NULL, NULL); return _p; }

inline http__address * soap_new_set_http__address(struct soap *soap, char *location) { http__address *_p = soap_instantiate_http__address(soap, -1, NULL, NULL, NULL); _p->http__address::location = location; return _p; }
...
#define SOAP_TYPE_dime__message (257)
#endif
...
#define soap_write_dime__message(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "dime:message", NULL) || soap_end_send(soap) )
#endif
...
inline dime__message * soap_new_req_dime__message(struct soap *soap) { dime__message *_p = soap_instantiate_dime__message(soap, -1, NULL, NULL, NULL); return _p; }

inline dime__message * soap_new_set_dime__message(struct soap *soap, char *layout) { dime__message *_p = soap_instantiate_dime__message(soap, -1, NULL, NULL, NULL); _p->dime__message::layout = layout; return _p; }
...
#define SOAP_TYPE_mime__mimeXml (256)
#endif
...
#define soap_write_mime__mimeXml(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mime:mimeXml", NULL) || soap_end_send(soap) )
#endif
...
inline mime__mimeXml * soap_new_req_mime__mimeXml(struct soap *soap) { mime__mimeXml *_p = soap_instantiate_mime__mimeXml(soap, -1, NULL, NULL, NULL); return _p; }

inline mime__mimeXml * soap_new_set_mime__mimeXml(struct soap *soap, char *part) { mime__mimeXml *_p = soap_instantiate_mime__mimeXml(soap, -1, NULL, NULL, NULL); _p->mime__mimeXml::part = part; return _p; }
...
#define SOAP_TYPE_mime__multipartRelated (253)
#endif
...
#define soap_write_mime__multipartRelated(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mime:multipartRelated", NULL) || soap_end_send(soap) )
#endif
...
inline mime__multipartRelated * soap_new_req_mime__multipartRelated(struct soap *soap) { mime__multipartRelated *_p = soap_instantiate_mime__multipartRelated(soap, -1, NULL, NULL, NULL); return _p; }

inline mime__multipartRelated * soap_new_set_mime__multipartRelated(struct soap *soap, std::vector<mime__part >& part) { mime__multipartRelated *_p = soap_instantiate_mime__multipartRelated(soap, -1, NULL, NULL, NULL); _p->mime__multipartRelated::part = part; return _p; }
...
#define SOAP_TYPE_mime__part (248)
#endif
...
#define soap_write_mime__part(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mime:part", NULL) || soap_end_send(soap) )
#endif
...
inline mime__part * soap_new_req_mime__part(struct soap *soap) { mime__part *_p = soap_instantiate_mime__part(soap, -1, NULL, NULL, NULL); return _p; }

inline mime__part * soap_new_set_mime__part(struct soap *soap, soap__body *soap__body_, std::vector<soap__header >& soap__header_, std::vector<mime__content >& content) { mime__part *_p = soap_instantiate_mime__part(soap, -1, NULL, NULL, NULL); _p->mime__part::soap__body_ = soap__body_; _p->mime__part::soap__header_ = soap__header_; _p->mime__part::content = content; return _p; }
...
#define SOAP_TYPE_mime__content (247)
#endif
...
#define soap_write_mime__content(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mime:content", NULL) || soap_end_send(soap) )
#endif
...
inline mime__content * soap_new_req_mime__content(struct soap *soap) { mime__content *_p = soap_instantiate_mime__content(soap, -1, NULL, NULL, NULL); return _p; }

inline mime__content * soap_new_set_mime__content(struct soap *soap, char *part, char *type) { mime__content *_p = soap_instantiate_mime__content(soap, -1, NULL, NULL, NULL); _p->mime__content::part = part; _p->mime__content::type = type; return _p; }
...
#define SOAP_TYPE_wsoap__header (243)
#endif
...
#define soap_write_wsoap__header(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsoap:header", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsoap__header(soap, data) ( soap_begin_recv(soap) || !soap_get_wsoap__header(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline wsoap__header * soap_new_req_wsoap__header(struct soap *soap) { wsoap__header *_p = soap_instantiate_wsoap__header(soap, -1, NULL, NULL, NULL); return _p; }

inline wsoap__header * soap_new_set_wsoap__header(struct soap *soap, char *element, bool mustUnderstand_, bool required) { wsoap__header *_p = soap_instantiate_wsoap__header(soap, -1, NULL, NULL, NULL); _p->wsoap__header::element = element; _p->wsoap__header::mustUnderstand_ = mustUnderstand_; _p->wsoap__header::required = required; return _p; }
...
#define SOAP_TYPE_wsoap__module (242)
#endif
...
#define soap_write_wsoap__module(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsoap:module", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_wsoap__module(soap, data) ( soap_begin_recv(soap) || !soap_get_wsoap__module(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
inline wsoap__module * soap_new_req_wsoap__module(struct soap *soap) { wsoap__module *_p = soap_instantiate_wsoap__module(soap, -1, NULL, NULL, NULL); return _p; }

inline wsoap__module * soap_new_set_wsoap__module(struct soap *soap, char *ref, bool required) { wsoap__module *_p = soap_instantiate_wsoap__module(soap, -1, NULL, NULL, NULL); _p->wsoap__module::ref = ref; _p->wsoap__module::required = required; return _p; }
...
#define soap_write_soap__address(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:address", NULL) || soap_end_send(soap) )
#endif
...
inline soap__address * soap_new_req_soap__address(struct soap *soap) { soap__address *_p = soap_instantiate_soap__address(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__address * soap_new_set_soap__address(struct soap *soap, char *location) { soap__address *_p = soap_instantiate_soap__address(soap, -1, NULL, NULL, NULL); _p->soap__address::location = location; return _p; }
...
#define soap_write_soap__header(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:header", NULL) || soap_end_send(soap) )
#endif
...
inline soap__header * soap_new_req_soap__header(struct soap *soap) { soap__header *_p = soap_instantiate_soap__header(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__header * soap_new_set_soap__header(struct soap *soap, char *message, char *part, enum soap__useChoice use, char *encodingStyle, char *namespace_, std::vector<soap__headerfault >& headerfault) { soap__header *_p = soap_instantiate_soap__header(soap, -1, NULL, NULL, NULL); _p->soap__header::message = message; _p->soap__header::part = part; _p->soap__header::use = use; _p->soap__header::encodingStyle = encodingStyle; _p->soap__header::namespace_ = namespace_; _p->soap__header::headerfault = headerfault; return _p; }
...
#define soap_write_soap__headerfault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:headerfault", NULL) || soap_end_send(soap) )
#endif
...
inline soap__headerfault * soap_new_req_soap__headerfault(struct soap *soap) { soap__headerfault *_p = soap_instantiate_soap__headerfault(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__headerfault * soap_new_set_soap__headerfault(struct soap *soap, char *message, char *part, enum soap__useChoice use, char *encodingStyle, char *namespace_) { soap__headerfault *_p = soap_instantiate_soap__headerfault(soap, -1, NULL, NULL, NULL); _p->soap__headerfault::message = message; _p->soap__headerfault::part = part; _p->soap__headerfault::use = use; _p->soap__headerfault::encodingStyle = encodingStyle; _p->soap__headerfault::namespace_ = namespace_; return _p; }
...
#define soap_write_soap__fault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:fault", NULL) || soap_end_send(soap) )
#endif
...
inline soap__fault * soap_new_req_soap__fault(struct soap *soap) { soap__fault *_p = soap_instantiate_soap__fault(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__fault * soap_new_set_soap__fault(struct soap *soap, char *name, char *encodingStyle, enum soap__useChoice use, char *namespace_) { soap__fault *_p = soap_instantiate_soap__fault(soap, -1, NULL, NULL, NULL); _p->soap__fault::name = name; _p->soap__fault::encodingStyle = encodingStyle; _p->soap__fault::use = use; _p->soap__fault::namespace_ = namespace_; return _p; }
...
#define soap_write_soap__body(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:body", NULL) || soap_end_send(soap) )
#endif
...
inline soap__body * soap_new_req_soap__body(struct soap *soap) { soap__body *_p = soap_instantiate_soap__body(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__body * soap_new_set_soap__body(struct soap *soap, char *encodingStyle, char *parts, enum soap__useChoice use, char *namespace_) { soap__body *_p = soap_instantiate_soap__body(soap, -1, NULL, NULL, NULL); _p->soap__body::encodingStyle = encodingStyle; _p->soap__body::parts = parts; _p->soap__body::use = use; _p->soap__body::namespace_ = namespace_; return _p; }
...
#define soap_write_soap__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:operation", NULL) || soap_end_send(soap) )
#endif
...
inline soap__operation * soap_new_req_soap__operation(struct soap *soap) { soap__operation *_p = soap_instantiate_soap__operation(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__operation * soap_new_set_soap__operation(struct soap *soap, char *soapAction, bool soapActionRequired, enum soap__styleChoice *style) { soap__operation *_p = soap_instantiate_soap__operation(soap, -1, NULL, NULL, NULL); _p->soap__operation::soapAction = soapAction; _p->soap__operation::soapActionRequired = soapActionRequired; _p->soap__operation::style = style; return _p; }
...
#define soap_write_soap__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "soap:binding", NULL) || soap_end_send(soap) )
#endif
...
inline soap__binding * soap_new_req_soap__binding(struct soap *soap) { soap__binding *_p = soap_instantiate_soap__binding(soap, -1, NULL, NULL, NULL); return _p; }

inline soap__binding * soap_new_set_soap__binding(struct soap *soap, char *transport, enum soap__styleChoice *style) { soap__binding *_p = soap_instantiate_soap__binding(soap, -1, NULL, NULL, NULL); _p->soap__binding::transport = transport; _p->soap__binding::style = style; return _p; }
...
#define soap_write_wsdl__part(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:part", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__part * soap_new_req_wsdl__part(struct soap *soap) { wsdl__part *_p = soap_instantiate_wsdl__part(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__part * soap_new_set_wsdl__part(struct soap *soap, char *name, char *element, char *type, char *documentation) { wsdl__part *_p = soap_instantiate_wsdl__part(soap, -1, NULL, NULL, NULL); _p->wsdl__part::name = name; _p->wsdl__part::element = element; _p->wsdl__part::type = type; _p->wsdl__part::documentation = documentation; return _p; }
...
#define soap_write_wsdl__message(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:message", NULL) || soap_end_send(soap) )
#endif
...
inline wsdl__message * soap_new_req_wsdl__message(struct soap *soap) { wsdl__message *_p = soap_instantiate_wsdl__message(soap, -1, NULL, NULL, NULL); return _p; }

inline wsdl__message * soap_new_set_wsdl__message(struct soap *soap, char *name, char *documentation, std::vector<wsp__Policy >& wsp__Policy_, std::vector<wsp__PolicyReference >& wsp__PolicyReference_, std::vector<wsdl__part >& part) { wsdl__message *_p = soap_instantiate_wsdl__message(soap, -1, NULL, NULL, NULL); _p->wsdl__message::name = name; _p->wsdl__message::documentation = documentation; _p->wsdl__message::wsp__Policy_ = wsp__Policy_; _p->wsdl__message::wsp__PolicyReference_ = wsp__PolicyReference_; _p->wsdl__message::part = part; return _p; }
...
#define soap_write_wsdl__definitions(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "wsdl:definitions", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__redefine(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:redefine", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__include(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:include", NULL) || soap_end_send(soap) )
#endif
...
inline xs__include * soap_new_req_xs__include(struct soap *soap) { xs__include *_p = soap_instantiate_xs__include(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__include * soap_new_set_xs__include(struct soap *soap, char *schemaLocation) { xs__include *_p = soap_instantiate_xs__include(soap, -1, NULL, NULL, NULL); _p->xs__include::schemaLocation = schemaLocation; return _p; }
...
#define soap_write_xs__import(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:import", NULL) || soap_end_send(soap) )
#endif
...
inline xs__import * soap_new_req_xs__import(struct soap *soap) { xs__import *_p = soap_instantiate_xs__import(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__import * soap_new_set_xs__import(struct soap *soap, char *namespace_, char *schemaLocation) { xs__import *_p = soap_instantiate_xs__import(soap, -1, NULL, NULL, NULL); _p->xs__import::namespace_ = namespace_; _p->xs__import::schemaLocation = schemaLocation; return _p; }
...
#define soap_write_xs__complexContent(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:complexContent", NULL) || soap_end_send(soap) )
#endif
...
inline xs__complexContent * soap_new_req_xs__complexContent(struct soap *soap) { xs__complexContent *_p = soap_instantiate_xs__complexContent(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__complexContent * soap_new_set_xs__complexContent(struct soap *soap, bool mixed, xs__extension *extension, xs__restriction *restriction) { xs__complexContent *_p = soap_instantiate_xs__complexContent(soap, -1, NULL, NULL, NULL); _p->xs__complexContent::mixed = mixed; _p->xs__complexContent::extension = extension; _p->xs__complexContent::restriction = restriction; return _p; }
...
#define soap_write_xs__whiteSpace(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:whiteSpace", NULL) || soap_end_send(soap) )
#endif
...
inline xs__whiteSpace * soap_new_req_xs__whiteSpace(struct soap *soap) { xs__whiteSpace *_p = soap_instantiate_xs__whiteSpace(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__whiteSpace * soap_new_set_xs__whiteSpace(struct soap *soap, char *value) { xs__whiteSpace *_p = soap_instantiate_xs__whiteSpace(soap, -1, NULL, NULL, NULL); _p->xs__whiteSpace::value = value; return _p; }
...
#define soap_write_xs__length(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:length", NULL) || soap_end_send(soap) )
#endif
...
inline xs__length * soap_new_req_xs__length(struct soap *soap) { xs__length *_p = soap_instantiate_xs__length(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__length * soap_new_set_xs__length(struct soap *soap, char *value, bool fixed, xs__annotation *annotation) { xs__length *_p = soap_instantiate_xs__length(soap, -1, NULL, NULL, NULL); _p->xs__length::value = value; _p->xs__length::fixed = fixed; _p->xs__length::annotation = annotation; return _p; }
...
#define soap_write_xs__simpleContent(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:simpleContent", NULL) || soap_end_send(soap) )
#endif
...
inline xs__simpleContent * soap_new_req_xs__simpleContent(struct soap *soap) { xs__simpleContent *_p = soap_instantiate_xs__simpleContent(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__simpleContent * soap_new_set_xs__simpleContent(struct soap *soap, xs__extension *extension, xs__restriction *restriction) { xs__simpleContent *_p = soap_instantiate_xs__simpleContent(soap, -1, NULL, NULL, NULL); _p->xs__simpleContent::extension = extension; _p->xs__simpleContent::restriction = restriction; return _p; }
...
#define soap_write_xs__pattern(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:pattern", NULL) || soap_end_send(soap) )
#endif
...
inline xs__pattern * soap_new_req_xs__pattern(struct soap *soap) { xs__pattern *_p = soap_instantiate_xs__pattern(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__pattern * soap_new_set_xs__pattern(struct soap *soap, char *value) { xs__pattern *_p = soap_instantiate_xs__pattern(soap, -1, NULL, NULL, NULL); _p->xs__pattern::value = value; return _p; }
...
#define soap_write_xs__enumeration(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:enumeration", NULL) || soap_end_send(soap) )
#endif
...
inline xs__enumeration * soap_new_req_xs__enumeration(struct soap *soap) { xs__enumeration *_p = soap_instantiate_xs__enumeration(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__enumeration * soap_new_set_xs__enumeration(struct soap *soap, char *value, char *value_, xs__annotation *annotation) { xs__enumeration *_p = soap_instantiate_xs__enumeration(soap, -1, NULL, NULL, NULL); _p->xs__enumeration::value = value; _p->xs__enumeration::value_ = value_; _p->xs__enumeration::annotation = annotation; return _p; }
...
#define soap_write_xs__attributeGroup(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:attributeGroup", NULL) || soap_end_send(soap) )
#endif
...
inline xs__attributeGroup * soap_new_req_xs__attributeGroup(struct soap *soap) { xs__attributeGroup *_p = soap_instantiate_xs__attributeGroup(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__attributeGroup * soap_new_set_xs__attributeGroup(struct soap *soap, char *name, char *ref, xs__annotation *annotation, std::vector<xs__attribute >& attribute, std::vector<xs__attributeGroup >& attributeGroup, xs__anyAttribute *anyAttribute) { xs__attributeGroup *_p = soap_instantiate_xs__attributeGroup(soap, -1, NULL, NULL, NULL); _p->xs__attributeGroup::name = name; _p->xs__attributeGroup::ref = ref; _p->xs__attributeGroup::annotation = annotation; _p->xs__attributeGroup::attribute = attribute; _p->xs__attributeGroup::attributeGroup = attributeGroup; _p->xs__attributeGroup::anyAttribute = anyAttribute; return _p; }
...
#define soap_write_xs__anyAttribute(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:anyAttribute", NULL) || soap_end_send(soap) )
#endif
...
inline xs__anyAttribute * soap_new_req_xs__anyAttribute(struct soap *soap) { xs__anyAttribute *_p = soap_instantiate_xs__anyAttribute(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__anyAttribute * soap_new_set_xs__anyAttribute(struct soap *soap, char *namespace_, enum xs__processContents processContents) { xs__anyAttribute *_p = soap_instantiate_xs__anyAttribute(soap, -1, NULL, NULL, NULL); _p->xs__anyAttribute::namespace_ = namespace_; _p->xs__anyAttribute::processContents = processContents; return _p; }
...
#define soap_write_xs__contents(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:contents", NULL) || soap_end_send(soap) )
#endif
...
inline xs__contents * soap_new_req_xs__contents(struct soap *soap, int __union, union xs__union_content& __content) { xs__contents *_p = soap_instantiate_xs__contents(soap, -1, NULL, NULL, NULL); _p->xs__contents::__union = __union; _p->xs__contents::__content = __content; return _p; }

inline xs__contents * soap_new_set_xs__contents(struct soap *soap, int __union, union xs__union_content& __content) { xs__contents *_p = soap_instantiate_xs__contents(soap, -1, NULL, NULL, NULL); _p->xs__contents::__union = __union; _p->xs__contents::__content = __content; return _p; }
...
#define soap_write_xs__any(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:any", NULL) || soap_end_send(soap) )
#endif
...
inline xs__any * soap_new_req_xs__any(struct soap *soap) { xs__any *_p = soap_instantiate_xs__any(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__any * soap_new_set_xs__any(struct soap *soap, char *namespace_, enum xs__processContents processContents, char *minOccurs, char *maxOccurs, std::vector<xs__element >& element) { xs__any *_p = soap_instantiate_xs__any(soap, -1, NULL, NULL, NULL); _p->xs__any::namespace_ = namespace_; _p->xs__any::processContents = processContents; _p->xs__any::minOccurs = minOccurs; _p->xs__any::maxOccurs = maxOccurs; _p->xs__any::element = element; return _p; }
...
#define soap_write_xs__all(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:all", NULL) || soap_end_send(soap) )
#endif
...
inline xs__all * soap_new_req_xs__all(struct soap *soap) { xs__all *_p = soap_instantiate_xs__all(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__all * soap_new_set_xs__all(struct soap *soap, std::vector<xs__element >& element) { xs__all *_p = soap_instantiate_xs__all(soap, -1, NULL, NULL, NULL); _p->xs__all::element = element; return _p; }
...
#define soap_write_xs__attribute(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:attribute", NULL) || soap_end_send(soap) )
#endif
...
inline xs__attribute * soap_new_req_xs__attribute(struct soap *soap) { xs__attribute *_p = soap_instantiate_xs__attribute(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__attribute * soap_new_set_xs__attribute(struct soap *soap, char *name, char *ref, char *type, enum xs__attribute_use use, char *default_, char *default__, char *fixed, char *fixed_, enum xs__formChoice *form, char *wsdl__arrayType, xs__annotation *annotation, xs__simpleType *simpleType) { xs__attribute *_p = soap_instantiate_xs__attribute(soap, -1, NULL, NULL, NULL); _p->xs__attribute::name = name; _p->xs__attribute::ref = ref; _p->xs__attribute::type = type; _p->xs__attribute::use = use; _p->xs__attribute::default_ = default_; _p->xs__attribute::default__ = default__; _p->xs__attribute::fixed = fixed; _p->xs__attribute::fixed_ = fixed_; _p->xs__attribute::form = form; _p->xs__attribute::wsdl__arrayType = wsdl__arrayType; _p->xs__attribute::annotation = annotation; _p->xs__attribute::simpleType = simpleType; return _p; }
...
#define soap_write_xs__element(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:element", NULL) || soap_end_send(soap) )
#endif
...
inline xs__element * soap_new_req_xs__element(struct soap *soap) { xs__element *_p = soap_instantiate_xs__element(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__element * soap_new_set_xs__element(struct soap *soap, char *name, char *ref, char *type, char *default_, char *default__, char *fixed, char *fixed_, enum xs__formChoice *form, bool nillable, bool abstract, char *substitutionGroup, char *minOccurs, char *maxOccurs, char *xmime__expectedContentTypes, xs__annotation *annotation, xs__simpleType *simpleType, xs__complexType *complexType) { xs__element *_p = soap_instantiate_xs__element(soap, -1, NULL, NULL, NULL); _p->xs__element::name = name; _p->xs__element::ref = ref; _p->xs__element::type = type; _p->xs__element::default_ = default_; _p->xs__element::default__ = default__; _p->xs__element::fixed = fixed; _p->xs__element::fixed_ = fixed_; _p->xs__element::form = form; _p->xs__element::nillable = nillable; _p->xs__element::abstract = abstract; _p->xs__element::substitutionGroup = substitutionGroup; _p->xs__element::minOccurs = minOccurs; _p->xs__element::maxOccurs = maxOccurs; _p->xs__element::xmime__expectedContentTypes = xmime__expectedContentTypes; _p->xs__element::annotation = annotation; _p->xs__element::simpleType = simpleType; _p->xs__element::complexType = complexType; return _p; }
...
#define soap_write_xs__annotation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:annotation", NULL) || soap_end_send(soap) )
#endif
...
inline xs__annotation * soap_new_req_xs__annotation(struct soap *soap) { xs__annotation *_p = soap_instantiate_xs__annotation(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__annotation * soap_new_set_xs__annotation(struct soap *soap, char *documentation) { xs__annotation *_p = soap_instantiate_xs__annotation(soap, -1, NULL, NULL, NULL); _p->xs__annotation::documentation = documentation; return _p; }
...
#define soap_write_xs__union(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:union", NULL) || soap_end_send(soap) )
#endif
...
inline xs__union * soap_new_req_xs__union(struct soap *soap) { xs__union *_p = soap_instantiate_xs__union(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__union * soap_new_set_xs__union(struct soap *soap, char *memberTypes, std::vector<xs__simpleType >& simpleType) { xs__union *_p = soap_instantiate_xs__union(soap, -1, NULL, NULL, NULL); _p->xs__union::memberTypes = memberTypes; _p->xs__union::simpleType = simpleType; return _p; }
...
#define soap_write_xs__list(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:list", NULL) || soap_end_send(soap) )
#endif
...
inline xs__list * soap_new_req_xs__list(struct soap *soap) { xs__list *_p = soap_instantiate_xs__list(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__list * soap_new_set_xs__list(struct soap *soap, char *itemType, xs__restriction *restriction, std::vector<xs__simpleType >& simpleType) { xs__list *_p = soap_instantiate_xs__list(soap, -1, NULL, NULL, NULL); _p->xs__list::itemType = itemType; _p->xs__list::restriction = restriction; _p->xs__list::simpleType = simpleType; return _p; }
...
#define soap_write_xs__group(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:group", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__seqchoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:seqchoice", NULL) || soap_end_send(soap) )
#endif
...
inline xs__seqchoice * soap_new_req_xs__seqchoice(struct soap *soap) { xs__seqchoice *_p = soap_instantiate_xs__seqchoice(soap, -1, NULL, NULL, NULL); return _p; }

inline xs__seqchoice * soap_new_set_xs__seqchoice(struct soap *soap, char *minOccurs, char *maxOccurs, xs__annotation *annotation, std::vector<xs__contents >& __contents) { xs__seqchoice *_p = soap_instantiate_xs__seqchoice(soap, -1, NULL, NULL, NULL); _p->xs__seqchoice::minOccurs = minOccurs; _p->xs__seqchoice::maxOccurs = maxOccurs; _p->xs__seqchoice::annotation = annotation; _p->xs__seqchoice::__contents = __contents; return _p; }
...
#define soap_write_xs__restriction(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:restriction", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__extension(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:extension", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__complexType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:complexType", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__simpleType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:simpleType", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__schema(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || (data)->soap_put(soap, "xs:schema", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_SOAP_ENV__Fault (450)
#endif
...
#define SOAP_TYPE_SOAP_ENV__Reason (449)
#endif
...
#define SOAP_TYPE_SOAP_ENV__Detail (448)
#endif
...
#define SOAP_TYPE_SOAP_ENV__Code (446)
#endif
...
#define SOAP_TYPE_SOAP_ENV__Header (445)
#endif
...
#define SOAP_TYPE_wsdl__union_ioput (353)
#endif
...
#define SOAP_TYPE_PointerToSOAP_ENV__Reason (452)
#endif
...
#define SOAP_TYPE_PointerToSOAP_ENV__Detail (451)
#endif
...
#define SOAP_TYPE_PointerToSOAP_ENV__Code (447)
#endif
...
#define SOAP_TYPE_PointerTowsdl__types (412)
#endif
...
#define soap_write_PointerTowsdl__types(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__types(soap, data, "wsdl:types", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__binding (402)
#endif
...
#define soap_write_PointerTowsdl__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__binding(soap, data, "wsdl:binding", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTohttp__address (401)
#endif
...
#define soap_write_PointerTohttp__address(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTohttp__address(soap, data, "http:address", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosoap__address (400)
#endif
...
#define soap_write_PointerTosoap__address(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__address(soap, data, "soap:address", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__portType (394)
#endif
...
#define soap_write_PointerTowsdl__portType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__portType(soap, data, "wsdl:portType", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTohttp__binding (392)
#endif
...
#define soap_write_PointerTohttp__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTohttp__binding(soap, data, "http:binding", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosoap__binding (391)
#endif
...
#define soap_write_PointerTosoap__binding(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__binding(soap, data, "soap:binding", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__ext_ioput (383)
#endif
...
#define soap_write_PointerTowsdl__ext_ioput(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__ext_ioput(soap, data, "wsdl:ext-ioput", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_PointerTowsdl__ext_ioput(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTowsdl__ext_ioput(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif


#ifndef SOAP_TYPE_PointerTohttp__operation
#define SOAP_TYPE_PointerTohttp__operation (382)
#endif
...
#define soap_write_PointerTohttp__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTohttp__operation(soap, data, "http:operation", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosoap__operation (381)
#endif
...
#define soap_write_PointerTosoap__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__operation(soap, data, "soap:operation", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__fault (373)
#endif
...
#define soap_write_PointerTowsdl__fault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__fault(soap, data, "wsdl:fault", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_PointerTowsdl__fault(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTowsdl__fault(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif


#ifndef SOAP_TYPE_PointerTosoap__fault
#define SOAP_TYPE_PointerTosoap__fault (372)
#endif
...
#define soap_write_PointerTosoap__fault(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__fault(soap, data, "soap:fault", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTomime__mimeXml (366)
#endif
...
#define soap_write_PointerTomime__mimeXml(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTomime__mimeXml(soap, data, "mime:mimeXml", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTomime__content (365)
#endif
...
#define soap_write_PointerTomime__content(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTomime__content(soap, data, "mime:content", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTomime__multipartRelated (364)
#endif
...
#define soap_write_PointerTomime__multipartRelated(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTomime__multipartRelated(soap, data, "mime:multipartRelated", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTodime__message (363)
#endif
...
#define soap_write_PointerTodime__message(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTodime__message(soap, data, "dime:message", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__ioput (352)
#endif
...
#define soap_write_PointerTowsdl__ioput(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__ioput(soap, data, "wsdl:ioput", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_PointerTowsdl__ioput(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTowsdl__ioput(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif


#ifndef SOAP_TYPE_PointerTowsdl__definitions
#define SOAP_TYPE_PointerTowsdl__definitions (315)
#endif
...
#define soap_write_PointerTowsdl__definitions(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__definitions(soap, data, "wsdl:definitions", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsp__AppliesTo (312)
#endif
...
#define soap_write_PointerTowsp__AppliesTo(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsp__AppliesTo(soap, data, "wsp:AppliesTo", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsrmp__RMAssertion (303)
#endif
...
#define soap_write_PointerTowsrmp__RMAssertion(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsrmp__RMAssertion(soap, data, "wsrmp:RMAssertion", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsp__Assertion (302)
#endif
...
#define soap_write_PointerTowsp__Assertion(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsp__Assertion(soap, data, "wsp:Assertion", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosp__Token (301)
#endif
...
#define soap_write_PointerTosp__Token(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosp__Token(soap, data, "sp:Token", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosp__Elements (300)
#endif
...
#define soap_write_PointerTosp__Elements(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosp__Elements(soap, data, "sp:Elements", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsp__PolicyReference (297)
#endif
...
#define soap_write_PointerTowsp__PolicyReference(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsp__PolicyReference(soap, data, "wsp:PolicyReference", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsrmp__Timeout (296)
#endif
...
#define soap_write_PointerTowsrmp__Timeout(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsrmp__Timeout(soap, data, "wsrmp:Timeout", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_PointerTowsrmp__Timeout(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTowsrmp__Timeout(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif


#ifndef SOAP_TYPE_PointerTowst__Claims
#define SOAP_TYPE_PointerTowst__Claims (293)
#endif
...
#define soap_write_PointerTowst__Claims(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowst__Claims(soap, data, "wst:Claims", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsa__EndpointReferenceType (292)
#endif
...
#define soap_write_PointerTowsa__EndpointReferenceType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsa__EndpointReferenceType(soap, data, "wsa:EndpointReferenceType", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsp__Content (284)
#endif
...
#define soap_write_PointerTowsp__Content(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsp__Content(soap, data, "wsp:Content", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsp__Policy (278)
#endif
...
#define soap_write_PointerTowsp__Policy(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsp__Policy(soap, data, "wsp:Policy", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosd__staticServiceDataValues (271)
#endif
...
#define soap_write_PointerTosd__staticServiceDataValues(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosd__staticServiceDataValues(soap, data, "sd:staticServiceDataValues", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTowsdl__operation (268)
#endif
...
#define soap_write_PointerTowsdl__operation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__operation(soap, data, "wsdl:operation", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_PointerTosoap__body (249)
#endif
...
#define soap_write_PointerTosoap__body(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__body(soap, data, "soap:body", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerTowsdl__part(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__part(soap, data, "wsdl:part", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerTowsdl__message(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTowsdl__message(soap, data, "wsdl:message", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerTosoap__styleChoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTosoap__styleChoice(soap, data, "soap:styleChoice", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__complexContent(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__complexContent(soap, data, "xs:complexContent", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__simpleContent(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__simpleContent(soap, data, "xs:simpleContent", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__length(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__length(soap, data, "xs:length", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__whiteSpace(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__whiteSpace(soap, data, "xs:whiteSpace", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__union(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__union(soap, data, "xs:union", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__list(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__list(soap, data, "xs:list", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__restriction(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__restriction(soap, data, "xs:restriction", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__extension(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__extension(soap, data, "xs:extension", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__attributeGroup(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__attributeGroup(soap, data, "xs:attributeGroup", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__anyAttribute(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__anyAttribute(soap, data, "xs:anyAttribute", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__all(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__all(soap, data, "xs:all", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__any(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__any(soap, data, "xs:any", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__seqchoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__seqchoice(soap, data, "xs:seqchoice", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__group(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__group(soap, data, "xs:group", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xs__namespaceList(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xs__namespaceList(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__attribute(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__attribute(soap, data, "xs:attribute", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerTostd__vectorTemplateOfPointerToxs__element(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerTostd__vectorTemplateOfPointerToxs__element(soap, data, "", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__element(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__element(soap, data, "xs:element", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__schema(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__schema(soap, data, "xs:schema", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__complexType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__complexType(soap, data, "xs:complexType", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__simpleType(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__simpleType(soap, data, "xs:simpleType", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__annotation(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__annotation(soap, data, "xs:annotation", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_PointerToxs__formChoice(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_PointerToxs__formChoice(soap, data, "xs:formChoice", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__QName(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__QName(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__NMTOKENS(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__NMTOKENS(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__NMTOKEN(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__NMTOKEN(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__NCName(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__NCName(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__ID(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__ID(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_xsd__anyURI(soap, data) ( soap_set_omode(soap, SOAP_XML_TREE), soap_begin(soap), soap_begin_send(soap) || soap_put_xsd__anyURI(soap, data, "byte", NULL) || soap_end_send(soap) )
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfgwsdl__portType (417)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__service (416)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__binding (415)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__portType (414)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__message (413)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__import (411)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__port (409)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__ext_operation (393)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__ext_fault (384)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwhttp__header (369)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsoap__header (368)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsoap__module (367)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__operation (357)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__fault (354)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsdl__part (336)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsp__PolicyReference (335)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsp__Policy (334)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfPointerToxs__schema (323)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfwsp__Attachment (313)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOf_XML (304)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfsp__Parts (299)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfPointerTowsp__Content (298)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfxsd__string (290)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfsp__Header (288)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfsd__serviceData (270)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfPointerTowsdl__operation (269)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfmime__part (254)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfmime__content (251)
#endif
...
#define SOAP_TYPE_std__vectorTemplateOfsoap__header (250)
#endif
