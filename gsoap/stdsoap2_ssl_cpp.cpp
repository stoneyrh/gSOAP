...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.8.34 2016-08-17 00:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.8.34 2016-08-17 00:00:00 GMT")
#endif
...
{ size_t n = strlen(s);
  ...
  { char *r = soap->msgbuf;
    ...
    { soap_strncat(soap->msgbuf, sizeof(soap->msgbuf), s, n);
      if (t)
