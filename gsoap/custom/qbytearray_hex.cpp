...
QByteArray *soap_in_xsd__hexBinary(struct soap *soap, char const *tag, QByteArray *a, char const *type)
{
  ...
  a = (QByteArray*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_xsd__hexBinary, sizeof(QByteArray), NULL, NULL, NULL, NULL);
  if (*soap->href)
  {
    a = (QByteArray*)soap_id_forward(soap, soap->href, a, 0, SOAP_TYPE_xsd__hexBinary, 0, sizeof(QByteArray), 0, NULL, NULL);
  }
  else if (a)
  {
