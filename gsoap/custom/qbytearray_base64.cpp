...
/* include soapH.h generated by soapcpp2 from .h file containing #import "qbytearray_base64.h" */
...
static int delete_xsd__base64Binary(struct soap*, struct soap_clist*);
...
static void * instantiate_xsd__base64Binary(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
  ...
  struct soap_clist *cp = soap_link(soap, SOAP_TYPE_xsd__base64Binary, n, delete_xsd__base64Binary);
...
static int delete_xsd__base64Binary(struct soap *soap, struct soap_clist *p)
{
  (void)soap; /* appease -Wall -Werror */
