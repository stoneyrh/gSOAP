/*
	...
	See struct_tm_date.h for documentation.
...
/* include soapH.h generated by soapcpp2 from .h file containing struct tm */
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_xsd__date(struct soap *soap, struct tm *a)
{
  (void)soap; /* appease -Wall -Werror */
  memset((void*)a, 0, sizeof(struct tm));
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_xsd__date(struct soap *soap, struct tm const *a)
{
  (void)soap; (void)a;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_xsd__date(struct soap *soap, const char *tag, int id, const struct tm *a, const char *type)
{
...
SOAP_FMAC3 int SOAP_FMAC4 soap_s2xsd__date(struct soap *soap, const char *s, struct tm *a)
{
  memset((void*)a, 0, sizeof(struct tm));
  if (s)
  {
...
SOAP_FMAC3 struct tm * SOAP_FMAC4 soap_in_xsd__date(struct soap *soap, const char *tag, struct tm *a, const char *type)
{
  ...
  a = (struct tm*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_xsd__date, sizeof(struct tm), NULL, NULL, NULL, NULL);
  if (*soap->href)
    a = (struct tm*)soap_id_forward(soap, soap->href, a, 0, SOAP_TYPE_xsd__date, 0, sizeof(struct tm), 0, NULL, NULL);
  else if (a)
  {
